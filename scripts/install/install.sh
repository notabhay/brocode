...
release_url_for_asset() {
  ...
  printf 'https://github.com/openai/brocode/releases/download/rust-v%s/%s\n' "$resolved_version" "$asset"
}
...
resolve_version() {
  ...
  release_json="$(download_text "https://api.github.com/repos/openai/brocode/releases/latest")"
