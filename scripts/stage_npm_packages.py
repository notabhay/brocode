#!/usr/bin/env python3
"""Stage one or more Brocode npm packages for release."""
...
BUILD_SCRIPT = REPO_ROOT / "brocode-cli" / "scripts" / "build_npm_package.py"
INSTALL_NATIVE_DEPS = REPO_ROOT / "brocode-cli" / "scripts" / "install_native_deps.py"
WORKFLOW_NAME = ".github/workflows/rust-release.yml"
GITHUB_REPO = "openai/brocode"

_SPEC = importlib.util.spec_from_file_location("brocode_build_npm_package", BUILD_SCRIPT)
...
BROCODE_PLATFORM_PACKAGES = getattr(_BUILD_MODULE, "BROCODE_PLATFORM_PACKAGES", {})
...
def tarball_name_for_package(package: str, version: str) -> str:
    if package in BROCODE_PLATFORM_PACKAGES:
        platform = package.removeprefix("brocode-")
        return f"brocode-npm-{platform}-{version}.tgz"
