...
mod tests {
    ...
    fn write_chatgpt_auth(brocode_home: &Path) {
        ...
        let auth = AuthDotJson {
            ...
            tokens: Some(TokenData {
                id_token: brocode_core::token_data::parse_chatgpt_jwt_claims(&id_token)
    ...
    fn loads_local_chatgpt_auth_from_managed_auth() {
        ...
        write_chatgpt_auth(brocode_home.path());
    ...
    fn rejects_missing_local_auth() {
        ...
        let err =
            load_local_chatgpt_auth(brocode_home.path(), AuthCredentialsStoreMode::File, None)
