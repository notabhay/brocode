...
fn live_001_commit_on_overflow() {
    ...
    let mut term = match brocode_tui_app_server::custom_terminal::Terminal::with_options(backend) {
        Ok(t) => t,
    ...
    let mut rb = brocode_tui_app_server::live_wrap::RowBuilder::new(20);
    ...
    brocode_tui_app_server::insert_history::insert_history_lines(&mut term, lines)
