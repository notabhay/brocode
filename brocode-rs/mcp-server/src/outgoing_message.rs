...
impl OutgoingMessageSender {
    ...
    pub(crate) async fn send_event_as_notification(
        ...
        self.send_notification(OutgoingNotification {
            method: "brocode/event".to_string(),
...
// Additional mcp-specific data to be added to a [`brocode_protocol::protocol::Event`] as notification.params._meta
...
mod tests {
    ...
    async fn test_send_event_as_notification() -> Result<()> {
        ...
        assert_eq!(method, "brocode/event");
