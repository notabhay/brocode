...
use brocode_app_server_protocol::ExperimentalFeature;
...
use brocode_app_server_protocol::ExperimentalFeatureStage;
...
-> Result<()> {
    let brocode_home = TempDir::new()?;
    let project_cwd = brocode_home.path().join("project");
