...
- **ChatGPT managed (`chatgpt`)** (recommended): Brocode owns the ChatGPT OAuth flow and refresh tokens. Start via `account/login/start` with `type: "chatgpt"`; Brocode persists tokens to disk and refreshes them automatically.
