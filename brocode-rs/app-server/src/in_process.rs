...
//!
//! # Relationship to `brocode-app-server-client`
//!
//! This module provides the low-level runtime handle ([`InProcessClientHandle`]).
//! Higher-level callers (TUI, exec) should go through `brocode-app-server-client`,
...
use brocode_app_server_protocol::Result;
...
/// through `brocode-app-server-client`, which adds worker-task buffering,
    ...
    let runtime_handle = tokio::spawn(async move {
        ...
        let mut processor_handle = tokio::spawn(async move {
            let mut processor = MessageProcessor::new(MessageProcessorArgs {
                ...
                enable_brocode_api_key_env: args.enable_brocode_api_key_env,
            });
        ...
        let args = InProcessStartArgs {
            ...
            initialize: InitializeParams {
                client_info: ClientInfo {
                    name: "brocode-in-process-test".to_string(),
                    title: None,
