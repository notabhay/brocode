...
type PendingInterruptQueue = Vec<(
    ConnectionRequestId,
    crate::brocode_message_processor::ApiVersion,
)>;
...
pub(crate) struct PendingThreadResumeRequest {
    ...
    pub(crate) thread_summary: brocode_app_server_protocol::Thread,
}
...
pub(crate) struct ThreadState {
    ...
    listener_thread: Option<Weak<BrocodeThread>>,
}

impl ThreadState {
    pub(crate) fn listener_matches(&self, conversation: &Arc<BrocodeThread>) -> bool {
