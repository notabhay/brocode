use crate::brocode_message_processor::ApiVersion;
use crate::brocode_message_processor::read_rollout_items_from_rollout;
use crate::brocode_message_processor::read_summary_from_rollout;
use crate::brocode_message_processor::summary_to_thread;
...
use brocode_app_server_protocol::AccountRateLimitsUpdatedNotification;
use brocode_app_server_protocol::AdditionalPermissionProfile as V2AdditionalPermissionProfile;
use brocode_app_server_protocol::AgentMessageDeltaNotification;
use brocode_app_server_protocol::ApplyPatchApprovalParams;
use brocode_app_server_protocol::ApplyPatchApprovalResponse;
use brocode_app_server_protocol::BrocodeErrorInfo as V2BrocodeErrorInfo;
use brocode_app_server_protocol::CollabAgentState as V2CollabAgentStatus;
use brocode_app_server_protocol::CollabAgentTool;
use brocode_app_server_protocol::CollabAgentToolCallStatus as V2CollabToolCallStatus;
use brocode_app_server_protocol::CommandAction as V2ParsedCommand;
use brocode_app_server_protocol::CommandExecutionApprovalDecision;
use brocode_app_server_protocol::CommandExecutionOutputDeltaNotification;
use brocode_app_server_protocol::CommandExecutionRequestApprovalParams;
use brocode_app_server_protocol::CommandExecutionRequestApprovalResponse;
use brocode_app_server_protocol::CommandExecutionRequestApprovalSkillMetadata;
use brocode_app_server_protocol::CommandExecutionSource;
use brocode_app_server_protocol::CommandExecutionStatus;
use brocode_app_server_protocol::ContextCompactedNotification;
use brocode_app_server_protocol::DeprecationNoticeNotification;
use brocode_app_server_protocol::DynamicToolCallOutputContentItem;
use brocode_app_server_protocol::DynamicToolCallParams;
use brocode_app_server_protocol::DynamicToolCallStatus;
use brocode_app_server_protocol::ErrorNotification;
use brocode_app_server_protocol::ExecCommandApprovalParams;
use brocode_app_server_protocol::ExecCommandApprovalResponse;
use brocode_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use brocode_app_server_protocol::FileChangeApprovalDecision;
use brocode_app_server_protocol::FileChangeOutputDeltaNotification;
use brocode_app_server_protocol::FileChangeRequestApprovalParams;
use brocode_app_server_protocol::FileChangeRequestApprovalResponse;
use brocode_app_server_protocol::FileUpdateChange;
use brocode_app_server_protocol::GrantedPermissionProfile as V2GrantedPermissionProfile;
...
use brocode_app_server_protocol::InterruptConversationResponse;
...
use brocode_app_server_protocol::McpServerElicitationAction;
use brocode_app_server_protocol::McpServerElicitationRequestParams;
use brocode_app_server_protocol::McpServerElicitationRequestResponse;
use brocode_app_server_protocol::McpServerStartupState;
use brocode_app_server_protocol::McpServerStatusUpdatedNotification;
use brocode_app_server_protocol::McpToolCallError;
use brocode_app_server_protocol::McpToolCallResult;
use brocode_app_server_protocol::McpToolCallStatus;
use brocode_app_server_protocol::ModelReroutedNotification;
use brocode_app_server_protocol::NetworkApprovalContext as V2NetworkApprovalContext;
use brocode_app_server_protocol::NetworkPolicyAmendment as V2NetworkPolicyAmendment;
use brocode_app_server_protocol::NetworkPolicyRuleAction as V2NetworkPolicyRuleAction;
use brocode_app_server_protocol::PatchApplyStatus;
use brocode_app_server_protocol::PermissionsRequestApprovalParams;
use brocode_app_server_protocol::PermissionsRequestApprovalResponse;
use brocode_app_server_protocol::PlanDeltaNotification;
use brocode_app_server_protocol::RawResponseItemCompletedNotification;
use brocode_app_server_protocol::ReasoningSummaryPartAddedNotification;
use brocode_app_server_protocol::ReasoningSummaryTextDeltaNotification;
use brocode_app_server_protocol::ReasoningTextDeltaNotification;
...
use brocode_app_server_protocol::SkillsChangedNotification;
use brocode_app_server_protocol::TerminalInteractionNotification;
use brocode_app_server_protocol::ThreadItem;
use brocode_app_server_protocol::ThreadNameUpdatedNotification;
use brocode_app_server_protocol::ThreadRealtimeClosedNotification;
use brocode_app_server_protocol::ThreadRealtimeErrorNotification;
use brocode_app_server_protocol::ThreadRealtimeItemAddedNotification;
use brocode_app_server_protocol::ThreadRealtimeOutputAudioDeltaNotification;
use brocode_app_server_protocol::ThreadRealtimeStartedNotification;
use brocode_app_server_protocol::ThreadRealtimeTranscriptUpdatedNotification;
...
use brocode_app_server_protocol::ToolRequestUserInputOption;
use brocode_app_server_protocol::ToolRequestUserInputParams;
use brocode_app_server_protocol::ToolRequestUserInputQuestion;
use brocode_app_server_protocol::ToolRequestUserInputResponse;
use brocode_app_server_protocol::Turn;
use brocode_app_server_protocol::TurnCompletedNotification;
use brocode_app_server_protocol::TurnDiffUpdatedNotification;
use brocode_app_server_protocol::TurnError;
use brocode_app_server_protocol::TurnInterruptResponse;
use brocode_app_server_protocol::TurnPlanStep;
use brocode_app_server_protocol::TurnPlanUpdatedNotification;
...
use brocode_app_server_protocol::convert_patch_changes;
use brocode_core::BrocodeThread;
use brocode_core::ThreadManager;
use brocode_core::find_thread_name_by_id;
use brocode_core::review_format::format_review_findings_block;
use brocode_core::review_prompts;
use brocode_protocol::ThreadId;
use brocode_protocol::dynamic_tools::DynamicToolCallOutputContentItem as CoreDynamicToolCallOutputContentItem;
use brocode_protocol::dynamic_tools::DynamicToolResponse as CoreDynamicToolResponse;
use brocode_protocol::items::parse_hook_prompt_message;
...
use brocode_protocol::protocol::ReviewOutputEvent;
...
use brocode_protocol::request_permissions::RequestPermissionsResponse as CoreRequestPermissionsResponse;
use brocode_protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use brocode_protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
use brocode_sandboxing::policy_transforms::intersect_permission_profiles;
use brocode_shell_command::parse_command::shlex_join;
...
fn guardian_auto_approval_review_notification(
    ...
    let review = GuardianApprovalReview {
        status: match assessment.status {
            brocode_protocol::protocol::GuardianAssessmentStatus::InProgress => {
                GuardianApprovalReviewStatus::InProgress
            }
            brocode_protocol::protocol::GuardianAssessmentStatus::Approved => {
                GuardianApprovalReviewStatus::Approved
            }
            brocode_protocol::protocol::GuardianAssessmentStatus::Denied => {
                GuardianApprovalReviewStatus::Denied
            }
            brocode_protocol::protocol::GuardianAssessmentStatus::Aborted => {
    ...
    match msg {
        ...
        EventMsg::McpStartupUpdate(update) => {
            if let ApiVersion::V2 = api_version {
                let (status, error) = match update.status {
                    brocode_protocol::protocol::McpStartupStatus::Starting => {
                        (McpServerStartupState::Starting, None)
                    }
                    brocode_protocol::protocol::McpStartupStatus::Ready => {
                        (McpServerStartupState::Ready, None)
                    }
                    brocode_protocol::protocol::McpStartupStatus::Failed { error } => {
                        (McpServerStartupState::Failed, Some(error))
                    }
                    brocode_protocol::protocol::McpStartupStatus::Cancelled => {
                    ...
                    Err(err) => {
                        ...
                        if let Err(err) = conversation
                            .submit(Op::ResolveElicitation {
                                ...
                                request_id: request.id,
                                decision: brocode_protocol::approvals::ElicitationAction::Cancel,
                                content: None,
                                meta: None,
                            })
                            .await
        ...
        EventMsg::CollabAgentSpawnEnd(end_event) => {
            ...
            let status = match &end_event.status {
                brocode_protocol::protocol::AgentStatus::Errored(_)
                | brocode_protocol::protocol::AgentStatus::NotFound => {
        ...
        EventMsg::AgentMessageContentDelta(event) => {
            let brocode_protocol::protocol::AgentMessageContentDeltaEvent {
                item_id, delta, ..
            } = event;
        ...
        EventMsg::Error(ev) => {
            ...
            let brocode_error_info = ev.brocode_error_info.clone();
            ...
            if matches!(
                brocode_error_info,
                Some(CoreBrocodeErrorInfo::ThreadRollbackFailed)
            ) {
            ...
            let turn_error = TurnError {
                message: ev.message,
                brocode_error_info: ev.brocode_error_info.map(V2BrocodeErrorInfo::from),
...
async fn maybe_emit_raw_response_item_completed(
    ...
    conversation_id: ThreadId,
    turn_id: &str,
    item: brocode_protocol::models::ResponseItem,
    outgoing: &ThreadScopedOutgoingMessageSender,
) {
...
async fn maybe_emit_hook_prompt_item_completed(
    ...
    let brocode_protocol::models::ResponseItem::Message {
        role, content, id, ..
    } = item
    else {
        return;
    ...
    let notification = ItemCompletedNotification {
        ...
        item: ThreadItem::HookPrompt {
            ...
            fragments: hook_prompt
                .fragments
                .into_iter()
                .map(brocode_app_server_protocol::HookPromptFragment::from)
                .collect(),
        },
    };
    outgoing
...
async fn on_exec_approval_response(
    ...
    // Try to deserialize `value` and then make the appropriate call to `brocode`.
    let response =
    ...
    let response = serde_json::from_value::<PermissionsRequestApprovalResponse>(value)
        .unwrap_or_else(|err| {
            ...
            PermissionsRequestApprovalResponse {
                ...
                scope: brocode_app_server_protocol::PermissionGrantScope::Turn,
            }
        });
...
fn collab_resume_begin_item(
    begin_event: brocode_protocol::protocol::CollabResumeBeginEvent,
) -> ThreadItem {
...
fn collab_resume_end_item(
    end_event: brocode_protocol::protocol::CollabResumeEndEvent,
) -> ThreadItem {
    let status = match &end_event.status {
        brocode_protocol::protocol::AgentStatus::Errored(_)
        | brocode_protocol::protocol::AgentStatus::NotFound => V2CollabToolCallStatus::Failed,
        _ => V2CollabToolCallStatus::Completed,
    };
    let receiver_id = end_event.receiver_thread_id.to_string();
    let agents_states = [(
...
mod tests {
    ...
    use brocode_protocol::items::HookPromptFragment;
    ...
    use brocode_protocol::protocol::McpInvocation;
    ...
    fn guardian_assessment_started_uses_event_turn_id_fallback() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                id: "item-1".to_string(),
                turn_id: String::new(),
                status: brocode_protocol::protocol::GuardianAssessmentStatus::InProgress,
                risk_score: None,
                risk_level: None,
                rationale: None,
    ...
    fn guardian_assessment_completed_emits_review_payload() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: brocode_protocol::protocol::GuardianAssessmentStatus::Denied,
                risk_score: Some(91),
                risk_level: Some(brocode_protocol::protocol::GuardianRiskLevel::High),
        ...
        match notification {
            ServerNotification::ItemGuardianApprovalReviewCompleted(payload) => {
                ...
                assert_eq!(
                    ...
                    Some(brocode_app_server_protocol::GuardianRiskLevel::High)
                );
    ...
    fn guardian_assessment_aborted_emits_completed_review_payload() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                id: "item-3".to_string(),
                turn_id: "turn-from-assessment".to_string(),
                status: brocode_protocol::protocol::GuardianAssessmentStatus::Aborted,
                risk_score: None,
                risk_level: None,
                rationale: None,
                action: Some(action.clone()),
    ...
    fn collab_resume_end_maps_to_item_completed_resume_agent() {
        let event = CollabResumeEndEvent {
            ...
            receiver_agent_nickname: None,
            receiver_agent_role: None,
            status: brocode_protocol::protocol::AgentStatus::NotFound,
        };
        ...
        let expected = ThreadItem::CollabAgentToolCall {
            ...
            agents_states: [(
                receiver_id,
                V2CollabAgentStatus::from(brocode_protocol::protocol::AgentStatus::NotFound),
            )]
            .into_iter()
            .collect(),
        };
    ...
    async fn test_handle_error_records_message() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                brocode_error_info: Some(V2BrocodeErrorInfo::InternalServerError),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_turn_complete_emits_failed_with_error() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                brocode_error_info: Some(V2BrocodeErrorInfo::Other),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_token_count_event_emits_usage_and_rate_limits() -> Result<()> {
        ...
        match second {
            OutgoingMessage::AppServerNotification(
                ...
                assert_eq!(payload.rate_limits.limit_id.as_deref(), Some("brocode"));
    ...
    async fn test_handle_turn_complete_emits_error_multiple_turns() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                brocode_error_info: Some(V2BrocodeErrorInfo::BadRequest),
                additional_details: None,
            },
            &thread_state,
        )
            ...
            OutgoingMessage::AppServerNotification(ServerNotification::ItemCompleted(
                ...
                assert_eq!(
                    ...
                    ThreadItem::HookPrompt {
                        ...
                        fragments: vec![
                            brocode_app_server_protocol::HookPromptFragment {
