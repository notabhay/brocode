...
use brocode_otel::span_w3c_trace_context;
...
mod tests {
    ...
    use brocode_app_server_protocol::ModelRerouteReason;
    ...
    fn verify_model_rerouted_notification_serialization() {
        let notification = ServerNotification::ModelRerouted(ModelReroutedNotification {
            ...
            from_model: "gpt-5.3-brocode".to_string(),
