...
use brocode_app_server_protocol::Account;
use brocode_app_server_protocol::AccountLoginCompletedNotification;
use brocode_app_server_protocol::AccountUpdatedNotification;
use brocode_app_server_protocol::AppInfo;
use brocode_app_server_protocol::AppsListParams;
use brocode_app_server_protocol::AppsListResponse;
use brocode_app_server_protocol::AskForApproval;
use brocode_app_server_protocol::AuthMode;
use brocode_app_server_protocol::BrocodeErrorInfo as AppServerBrocodeErrorInfo;
use brocode_app_server_protocol::CancelLoginAccountParams;
use brocode_app_server_protocol::CancelLoginAccountResponse;
use brocode_app_server_protocol::CancelLoginAccountStatus;
use brocode_app_server_protocol::ClientRequest;
use brocode_app_server_protocol::CollaborationModeListParams;
use brocode_app_server_protocol::CollaborationModeListResponse;
use brocode_app_server_protocol::CommandExecParams;
use brocode_app_server_protocol::CommandExecResizeParams;
use brocode_app_server_protocol::CommandExecTerminateParams;
use brocode_app_server_protocol::CommandExecWriteParams;
use brocode_app_server_protocol::ConversationGitInfo;
use brocode_app_server_protocol::ConversationSummary;
use brocode_app_server_protocol::DynamicToolSpec as ApiDynamicToolSpec;
use brocode_app_server_protocol::ExperimentalFeature as ApiExperimentalFeature;
use brocode_app_server_protocol::ExperimentalFeatureListParams;
use brocode_app_server_protocol::ExperimentalFeatureListResponse;
use brocode_app_server_protocol::ExperimentalFeatureStage as ApiExperimentalFeatureStage;
use brocode_app_server_protocol::FeedbackUploadParams;
use brocode_app_server_protocol::FeedbackUploadResponse;
use brocode_app_server_protocol::FuzzyFileSearchParams;
use brocode_app_server_protocol::FuzzyFileSearchResponse;
use brocode_app_server_protocol::FuzzyFileSearchSessionStartParams;
use brocode_app_server_protocol::FuzzyFileSearchSessionStartResponse;
use brocode_app_server_protocol::FuzzyFileSearchSessionStopParams;
use brocode_app_server_protocol::FuzzyFileSearchSessionStopResponse;
use brocode_app_server_protocol::FuzzyFileSearchSessionUpdateParams;
use brocode_app_server_protocol::FuzzyFileSearchSessionUpdateResponse;
use brocode_app_server_protocol::GetAccountParams;
use brocode_app_server_protocol::GetAccountRateLimitsResponse;
use brocode_app_server_protocol::GetAccountResponse;
use brocode_app_server_protocol::GetAuthStatusParams;
use brocode_app_server_protocol::GetAuthStatusResponse;
use brocode_app_server_protocol::GetConversationSummaryParams;
use brocode_app_server_protocol::GetConversationSummaryResponse;
use brocode_app_server_protocol::GitDiffToRemoteResponse;
use brocode_app_server_protocol::GitInfo as ApiGitInfo;
use brocode_app_server_protocol::JSONRPCErrorError;
use brocode_app_server_protocol::ListMcpServerStatusParams;
use brocode_app_server_protocol::ListMcpServerStatusResponse;
use brocode_app_server_protocol::LoginAccountParams;
use brocode_app_server_protocol::LoginAccountResponse;
use brocode_app_server_protocol::LoginApiKeyParams;
use brocode_app_server_protocol::LogoutAccountResponse;
use brocode_app_server_protocol::MarketplaceInterface;
use brocode_app_server_protocol::McpServerOauthLoginCompletedNotification;
use brocode_app_server_protocol::McpServerOauthLoginParams;
use brocode_app_server_protocol::McpServerOauthLoginResponse;
use brocode_app_server_protocol::McpServerRefreshResponse;
use brocode_app_server_protocol::McpServerStatus;
use brocode_app_server_protocol::MockExperimentalMethodParams;
use brocode_app_server_protocol::MockExperimentalMethodResponse;
use brocode_app_server_protocol::ModelListParams;
use brocode_app_server_protocol::ModelListResponse;
use brocode_app_server_protocol::PluginDetail;
use brocode_app_server_protocol::PluginInstallParams;
use brocode_app_server_protocol::PluginInstallResponse;
use brocode_app_server_protocol::PluginInterface;
use brocode_app_server_protocol::PluginListParams;
use brocode_app_server_protocol::PluginListResponse;
use brocode_app_server_protocol::PluginMarketplaceEntry;
use brocode_app_server_protocol::PluginReadParams;
use brocode_app_server_protocol::PluginReadResponse;
use brocode_app_server_protocol::PluginSource;
use brocode_app_server_protocol::PluginSummary;
use brocode_app_server_protocol::PluginUninstallParams;
use brocode_app_server_protocol::PluginUninstallResponse;
use brocode_app_server_protocol::RequestId;
use brocode_app_server_protocol::ReviewDelivery as ApiReviewDelivery;
use brocode_app_server_protocol::ReviewStartParams;
use brocode_app_server_protocol::ReviewStartResponse;
use brocode_app_server_protocol::ReviewTarget as ApiReviewTarget;
use brocode_app_server_protocol::SandboxMode;
use brocode_app_server_protocol::ServerNotification;
use brocode_app_server_protocol::ServerRequestResolvedNotification;
use brocode_app_server_protocol::SkillSummary;
use brocode_app_server_protocol::SkillsConfigWriteParams;
use brocode_app_server_protocol::SkillsConfigWriteResponse;
use brocode_app_server_protocol::SkillsListParams;
use brocode_app_server_protocol::SkillsListResponse;
use brocode_app_server_protocol::Thread;
use brocode_app_server_protocol::ThreadArchiveParams;
use brocode_app_server_protocol::ThreadArchiveResponse;
use brocode_app_server_protocol::ThreadArchivedNotification;
use brocode_app_server_protocol::ThreadBackgroundTerminalsCleanParams;
use brocode_app_server_protocol::ThreadBackgroundTerminalsCleanResponse;
use brocode_app_server_protocol::ThreadClosedNotification;
use brocode_app_server_protocol::ThreadCompactStartParams;
use brocode_app_server_protocol::ThreadCompactStartResponse;
use brocode_app_server_protocol::ThreadDecrementElicitationParams;
use brocode_app_server_protocol::ThreadDecrementElicitationResponse;
use brocode_app_server_protocol::ThreadForkParams;
use brocode_app_server_protocol::ThreadForkResponse;
use brocode_app_server_protocol::ThreadIncrementElicitationParams;
use brocode_app_server_protocol::ThreadIncrementElicitationResponse;
use brocode_app_server_protocol::ThreadItem;
use brocode_app_server_protocol::ThreadListParams;
use brocode_app_server_protocol::ThreadListResponse;
use brocode_app_server_protocol::ThreadLoadedListParams;
use brocode_app_server_protocol::ThreadLoadedListResponse;
use brocode_app_server_protocol::ThreadMetadataGitInfoUpdateParams;
use brocode_app_server_protocol::ThreadMetadataUpdateParams;
use brocode_app_server_protocol::ThreadMetadataUpdateResponse;
use brocode_app_server_protocol::ThreadNameUpdatedNotification;
use brocode_app_server_protocol::ThreadReadParams;
use brocode_app_server_protocol::ThreadReadResponse;
use brocode_app_server_protocol::ThreadRealtimeAppendAudioParams;
use brocode_app_server_protocol::ThreadRealtimeAppendAudioResponse;
use brocode_app_server_protocol::ThreadRealtimeAppendTextParams;
use brocode_app_server_protocol::ThreadRealtimeAppendTextResponse;
use brocode_app_server_protocol::ThreadRealtimeStartParams;
use brocode_app_server_protocol::ThreadRealtimeStartResponse;
use brocode_app_server_protocol::ThreadRealtimeStopParams;
use brocode_app_server_protocol::ThreadRealtimeStopResponse;
use brocode_app_server_protocol::ThreadResumeParams;
use brocode_app_server_protocol::ThreadResumeResponse;
use brocode_app_server_protocol::ThreadRollbackParams;
use brocode_app_server_protocol::ThreadSetNameParams;
use brocode_app_server_protocol::ThreadSetNameResponse;
use brocode_app_server_protocol::ThreadShellCommandParams;
use brocode_app_server_protocol::ThreadShellCommandResponse;
use brocode_app_server_protocol::ThreadSortKey;
use brocode_app_server_protocol::ThreadSourceKind;
use brocode_app_server_protocol::ThreadStartParams;
use brocode_app_server_protocol::ThreadStartResponse;
use brocode_app_server_protocol::ThreadStartedNotification;
use brocode_app_server_protocol::ThreadStatus;
use brocode_app_server_protocol::ThreadUnarchiveParams;
use brocode_app_server_protocol::ThreadUnarchiveResponse;
use brocode_app_server_protocol::ThreadUnarchivedNotification;
use brocode_app_server_protocol::ThreadUnsubscribeParams;
use brocode_app_server_protocol::ThreadUnsubscribeResponse;
use brocode_app_server_protocol::ThreadUnsubscribeStatus;
use brocode_app_server_protocol::Turn;
use brocode_app_server_protocol::TurnError;
use brocode_app_server_protocol::TurnInterruptParams;
use brocode_app_server_protocol::TurnStartParams;
use brocode_app_server_protocol::TurnStartResponse;
use brocode_app_server_protocol::TurnStatus;
use brocode_app_server_protocol::TurnSteerParams;
use brocode_app_server_protocol::TurnSteerResponse;
use brocode_app_server_protocol::UserInput as V2UserInput;
use brocode_app_server_protocol::WindowsSandboxSetupCompletedNotification;
use brocode_app_server_protocol::WindowsSandboxSetupMode;
use brocode_app_server_protocol::WindowsSandboxSetupStartParams;
use brocode_app_server_protocol::WindowsSandboxSetupStartResponse;
use brocode_app_server_protocol::build_turns_from_rollout_items;
use brocode_arg0::Arg0DispatchPaths;
use brocode_backend_client::Client as BackendClient;
use brocode_chatgpt::connectors;
use brocode_cloud_requirements::cloud_requirements_loader;
use brocode_core::AuthManager;
use brocode_core::BrocodeAuth;
use brocode_core::BrocodeThread;
use brocode_core::Cursor as RolloutCursor;
use brocode_core::ForkSnapshot;
use brocode_core::NewThread;
use brocode_core::RolloutRecorder;
use brocode_core::SessionMeta;
use brocode_core::SteerInputError;
use brocode_core::ThreadConfigSnapshot;
use brocode_core::ThreadManager;
use brocode_core::ThreadSortKey as CoreThreadSortKey;
use brocode_core::auth::AuthMode as CoreAuthMode;
use brocode_core::auth::CLIENT_ID;
use brocode_core::auth::login_with_api_key;
use brocode_core::config::Config;
use brocode_core::config::ConfigOverrides;
use brocode_core::config::NetworkProxyAuditMetadata;
use brocode_core::config::edit::ConfigEdit;
use brocode_core::config::edit::ConfigEditsBuilder;
use brocode_core::config::types::McpServerTransportConfig;
use brocode_core::config_loader::CloudRequirementsLoadError;
use brocode_core::config_loader::CloudRequirementsLoadErrorCode;
use brocode_core::config_loader::CloudRequirementsLoader;
use brocode_core::config_loader::LoaderOverrides;
use brocode_core::config_loader::load_config_layers_state;
use brocode_core::default_client::set_default_client_residency_requirement;
use brocode_core::error::BrocodeErr;
use brocode_core::error::Result as BrocodeResult;
use brocode_core::exec::ExecCapturePolicy;
use brocode_core::exec::ExecExpiration;
use brocode_core::exec::ExecParams;
use brocode_core::exec_env::create_env;
use brocode_core::find_archived_thread_path_by_id_str;
use brocode_core::find_thread_name_by_id;
use brocode_core::find_thread_names_by_ids;
use brocode_core::find_thread_path_by_id_str;
use brocode_core::mcp::auth::discover_supported_scopes;
use brocode_core::mcp::auth::resolve_oauth_scopes;
use brocode_core::mcp::collect_mcp_snapshot;
use brocode_core::mcp::group_tools_by_server;
use brocode_core::models_manager::collaboration_mode_presets::CollaborationModesConfig;
use brocode_core::parse_cursor;
use brocode_core::plugins::MarketplaceError;
use brocode_core::plugins::MarketplacePluginSource;
use brocode_core::plugins::OPENAI_CURATED_MARKETPLACE_NAME;
use brocode_core::plugins::PluginInstallError as CorePluginInstallError;
use brocode_core::plugins::PluginInstallRequest;
use brocode_core::plugins::PluginReadRequest;
use brocode_core::plugins::PluginUninstallError as CorePluginUninstallError;
use brocode_core::plugins::load_plugin_apps;
use brocode_core::plugins::load_plugin_mcp_servers;
use brocode_core::read_head_for_summary;
use brocode_core::read_session_meta_line;
use brocode_core::rollout_date_parts;
use brocode_core::sandboxing::SandboxPermissions;
use brocode_core::state_db::StateDbHandle;
use brocode_core::state_db::get_state_db;
use brocode_core::state_db::reconcile_rollout;
use brocode_core::windows_sandbox::WindowsSandboxLevelExt;
use brocode_core::windows_sandbox::WindowsSandboxSetupMode as CoreWindowsSandboxSetupMode;
use brocode_core::windows_sandbox::WindowsSandboxSetupRequest;
use brocode_features::FEATURES;
use brocode_features::Feature;
use brocode_features::Stage;
use brocode_feedback::BrocodeFeedback;
use brocode_git_utils::git_diff_to_remote;
...
use brocode_protocol::dynamic_tools::DynamicToolSpec as CoreDynamicToolSpec;
use brocode_protocol::items::TurnItem;
use brocode_protocol::models::ResponseItem;
use brocode_protocol::protocol::AgentStatus;
use brocode_protocol::protocol::ConversationAudioParams;
use brocode_protocol::protocol::ConversationStartParams;
use brocode_protocol::protocol::ConversationTextParams;
use brocode_protocol::protocol::EventMsg;
use brocode_protocol::protocol::GitInfo as CoreGitInfo;
use brocode_protocol::protocol::InitialHistory;
use brocode_protocol::protocol::McpAuthStatus as CoreMcpAuthStatus;
use brocode_protocol::protocol::McpServerRefreshConfig;
use brocode_protocol::protocol::Op;
use brocode_protocol::protocol::RateLimitSnapshot as CoreRateLimitSnapshot;
use brocode_protocol::protocol::ReviewDelivery as CoreReviewDelivery;
use brocode_protocol::protocol::ReviewRequest;
use brocode_protocol::protocol::ReviewTarget as CoreReviewTarget;
use brocode_protocol::protocol::RolloutItem;
use brocode_protocol::protocol::SessionConfiguredEvent;
use brocode_protocol::protocol::SessionMetaLine;
use brocode_protocol::protocol::USER_MESSAGE_BEGIN;
use brocode_protocol::protocol::W3cTraceContext;
use brocode_protocol::user_input::MAX_USER_INPUT_TEXT_CHARS;
use brocode_protocol::user_input::UserInput as CoreInputItem;
use brocode_rmcp_client::perform_oauth_login_return_url;
use brocode_state::StateRuntime;
use brocode_state::ThreadMetadata;
use brocode_state::ThreadMetadataBuilder;
use brocode_state::log_db::LogDbLayer;
use brocode_utils_absolute_path::AbsolutePathBuf;
use brocode_utils_json_to_toml::json_to_toml;
use brocode_utils_pty::DEFAULT_OUTPUT_BYTES_CAP;
use chrono::DateTime;
...
/// Handles JSON-RPC messages for Brocode threads (and legacy conversation APIs).
pub(crate) struct BrocodeMessageProcessor {
...
pub(crate) struct BrocodeMessageProcessorArgs {
    ...
    pub(crate) feedback: BrocodeFeedback,
    pub(crate) log_db: Option<LogDbLayer>,
}

impl BrocodeMessageProcessor {
    ...
    async fn load_thread(
        &self,
        thread_id: &str,
    ) -> Result<(ThreadId, Arc<BrocodeThread>), JSONRPCErrorError> {
    ...
    pub fn new(args: BrocodeMessageProcessorArgs) -> Self {
        let BrocodeMessageProcessorArgs {
            auth_manager,
            thread_manager,
            outgoing,
            arg0_paths,
    ...
    async fn load_latest_config(
        ...
        let mut config = brocode_core::config::ConfigBuilder::default()
        ...
        config.brocode_self_exe = self.arg0_paths.brocode_self_exe.clone();
        config.brocode_linux_sandbox_exe = self.arg0_paths.brocode_linux_sandbox_exe.clone();
    ...
    fn review_request_from_target(
        ...
        let hint = brocode_core::review_prompts::user_facing_hint(&core_target);
    ...
    pub async fn process_request(
        ...
        match request {
            ...
            | ClientRequest::ExperimentalFeatureEnablementSet { .. } => {
                warn!("Config request reached BrocodeMessageProcessor unexpectedly");
            }
            ...
            | ClientRequest::FsUnwatch { .. } => {
                warn!("Filesystem request reached BrocodeMessageProcessor unexpectedly");
            }
            ClientRequest::ConfigRequirementsRead { .. } => {
                warn!(
                    "ConfigRequirementsRead request reached BrocodeMessageProcessor unexpectedly"
                );
            }
            ClientRequest::ExternalAgentConfigDetect { .. }
            | ClientRequest::ExternalAgentConfigImport { .. } => {
                warn!("ExternalAgentConfig request reached BrocodeMessageProcessor unexpectedly");
            }
    ...
    async fn login_api_key_v2(
        ...
        match self.login_api_key_common(&params).await {
            Ok(()) => {
                let response = brocode_app_server_protocol::LoginAccountResponse::ApiKey {};
        ...
        match self.login_chatgpt_common().await {
            Ok(opts) => match run_login_server(opts) {
                Ok(server) => {
                    ...
                    let response = brocode_app_server_protocol::LoginAccountResponse::Chatgpt {
    ...
    > {
        let Some(auth) = self.auth_manager.auth().await else {
            return Err(JSONRPCErrorError {
                code: INVALID_REQUEST_ERROR_CODE,
                message: "brocode account authentication required to read rate limits".to_string(),
                data: None,
            });
        };
        ...
        let snapshots = client
            ...
            .map_err(|err| JSONRPCErrorError {
                code: INTERNAL_ERROR_CODE,
                message: format!("failed to fetch brocode rate limits: {err}"),
                data: None,
            })?;
        if snapshots.is_empty() {
            return Err(JSONRPCErrorError {
                code: INTERNAL_ERROR_CODE,
                message: "failed to fetch brocode rate limits: no snapshots returned".to_string(),
                data: None,
            });
        }
        ...
        let rate_limits_by_limit_id: HashMap<String, CoreRateLimitSnapshot> = snapshots
            ...
            .map(|snapshot| {
                let limit_id = snapshot
                    .limit_id
                    .clone()
                    .unwrap_or_else(|| "brocode".to_string());
                (limit_id, snapshot)
            })
            .collect();
        ...
        let primary = snapshots
            .iter()
            .find(|snapshot| snapshot.limit_id.as_deref() == Some("brocode"))
            .cloned()
    ...
    async fn exec_one_off_command(
        ...
        let exec_params = ExecParams {
            ...
            network: started_network_proxy
                .as_ref()
                .map(brocode_core::config::StartedNetworkProxy::proxy),
            ...
            Some(policy) => match self.config.permissions.sandbox_policy.can_set(&policy) {
                Ok(()) => {
                    let file_system_sandbox_policy =
                        brocode_protocol::permissions::FileSystemSandboxPolicy::from_legacy_sandbox_policy(&policy, &sandbox_cwd);
                    let network_sandbox_policy =
                        brocode_protocol::permissions::NetworkSandboxPolicy::from(&policy);
        ...
        let brocode_linux_sandbox_exe = self.arg0_paths.brocode_linux_sandbox_exe.clone();
        let outgoing = self.outgoing.clone();
        ...
        match brocode_core::exec::build_exec_request(
            exec_params,
            &effective_policy,
            &effective_file_system_sandbox_policy,
            effective_network_sandbox_policy,
            sandbox_cwd.as_path(),
            &brocode_linux_sandbox_exe,
            use_legacy_landlock,
        ) {
            Ok(exec_request) => {
    ...
    async fn thread_start(
        ...
        let listener_task_context = ListenerTaskContext {
            ...
            brocode_home: self.config.brocode_home.clone(),
        };
    ...
    async fn request_trace_context(
        &self,
        request_id: &ConnectionRequestId,
    ) -> Option<brocode_protocol::protocol::W3cTraceContext> {
    ...
    async fn thread_start_task(
        ...
        let config = match derive_config_from_params(
            ...
            typesafe_overrides,
            &cloud_requirements,
            &listener_task_context.brocode_home,
            &runtime_feature_enablement,
        )
        .await
        {
    ...
    fn build_thread_config_overrides(
        ...
        service_tier: Option<Option<brocode_protocol::config_types::ServiceTier>>,
        cwd: Option<String>,
        approval_policy: Option<brocode_app_server_protocol::AskForApproval>,
        approvals_reviewer: Option<brocode_app_server_protocol::ApprovalsReviewer>,
        ...
        ConfigOverrides {
            ...
            approval_policy: approval_policy
                .map(brocode_app_server_protocol::AskForApproval::to_core),
            approvals_reviewer: approvals_reviewer
                .map(brocode_app_server_protocol::ApprovalsReviewer::to_core),
            sandbox_mode: sandbox.map(SandboxMode::to_core),
            brocode_linux_sandbox_exe: self.arg0_paths.brocode_linux_sandbox_exe.clone(),
    ...
    async fn thread_archive(
        ...
        let rollout_path =
            match find_thread_path_by_id_str(&self.config.brocode_home, &thread_id.to_string())
                .await
            {
                Ok(Some(p)) => p,
                Ok(None) => {
    ...
    async fn thread_decrement_elicitation(
        ...
        match thread.decrement_out_of_band_elicitation_count().await {
            ...
            Err(BrocodeErr::InvalidRequest(message)) => {
    ...
    async fn thread_set_name(&self, request_id: ConnectionRequestId, params: ThreadSetNameParams) {
        ...
        let Some(name) = brocode_core::util::normalize_thread_name(&name) else {
        ...
        if let Err(err) =
            brocode_core::append_thread_name(&self.config.brocode_home, thread_id, &name).await
        {
            self.send_internal_error(request_id, format!("failed to set thread name: {err}"))
                .await;
            return;
    ...
    async fn ensure_thread_metadata_row_exists(
        ...
        loaded_thread: Option<&Arc<BrocodeThread>>,
        ...
        let rollout_path =
            match find_thread_path_by_id_str(&self.config.brocode_home, &thread_uuid.to_string())
                .await
            {
                Ok(Some(path)) => path,
    ...
    async fn thread_unarchive(
        ...
        let archived_folder = self
            .config
            .brocode_home
            .join(brocode_core::ARCHIVED_SESSIONS_SUBDIR);
        ...
        let result: Result<Thread, JSONRPCErrorError> = async {
            ...
            let sessions_folder = self.config.brocode_home.join(brocode_core::SESSIONS_SUBDIR);
    ...
    async fn thread_list(&self, request_id: ConnectionRequestId, params: ThreadListParams) {
        ...
        let names = match find_thread_names_by_ids(&self.config.brocode_home, &thread_ids).await {
            Ok(names) => names,
            Err(err) => {
    ...
    async fn attach_thread_name(&self, thread_id: ThreadId, thread: &mut Thread) {
        match find_thread_name_by_id(&self.config.brocode_home, &thread_id).await {
            Ok(name) => {
                thread.name = name;
            }
            Err(err) => {
    ...
    async fn thread_fork(&mut self, request_id: ConnectionRequestId, params: ThreadForkParams) {
            ...
            .await
        {
            ...
            Err(err) => {
                match err {
                    BrocodeErr::Io(_) | BrocodeErr::Json(_) => {
                        self.send_invalid_request_error(
                            request_id,
                            format!("failed to load rollout `{}`: {err}", rollout_path.display()),
                        )
                    ...
                    BrocodeErr::InvalidRequest(message) => {
                        self.send_invalid_request_error(request_id, message).await;
                    }
                    _ => {
                        self.send_internal_error(
        ...
        let path = match params {
            GetConversationSummaryParams::RolloutPath { rollout_path } => {
                if rollout_path.is_relative() {
                    self.config.brocode_home.join(&rollout_path)
                } else {
                    rollout_path
                }
            }
            GetConversationSummaryParams::ThreadId { conversation_id } => {
                match brocode_core::find_thread_path_by_id_str(
                    &self.config.brocode_home,
    ...
    async fn wait_for_thread_shutdown(thread: &Arc<BrocodeThread>) -> ThreadShutdownResult {
    ...
    async fn archive_thread_common(
        ...
        let rollout_folder = self.config.brocode_home.join(brocode_core::SESSIONS_SUBDIR);
        ...
        for cwd in cwds {
            ...
            let cwd_abs = match AbsolutePathBuf::try_from(cwd.as_path()) {
                ...
                Err(err) => {
                    ...
                    data.push(brocode_app_server_protocol::SkillsListEntry {
                        cwd,
                        skills: Vec::new(),
                        errors: errors_to_info(&[brocode_core::skills::SkillError {
                            path: error_path,
            ...
            let skills_input = brocode_core::skills::SkillsLoadInput::new(
                cwd.clone(),
        ...
        let (data, marketplace_load_errors) = match tokio::task::spawn_blocking(move || {
            ...
            Ok::<
                (
                    ...
                    Vec<brocode_app_server_protocol::MarketplaceLoadErrorInfo>,
                ),
                MarketplaceError,
            >((
                outcome
                ...
                outcome
                    ...
                    .into_iter()
                    .map(
                        |err| brocode_app_server_protocol::MarketplaceLoadErrorInfo {
    ...
    async fn skills_config_write(
        ...
        let edits = vec![edit];
        let result = ConfigEditsBuilder::new(&self.config.brocode_home)
            .with_edits(edits)
            .apply()
            .await;
        ...
        match install_result {
            Ok(result) => {
                    ...
                    || !config.features.apps_enabled(Some(&self.auth_manager)).await
                {
                    ...
                    let (accessible_connectors, brocode_apps_ready) =
                        match accessible_connectors_result {
                            Ok(status) => (status.connectors, status.brocode_apps_ready),
                            Err(err) => {
                                warn!(
                                    plugin = result.plugin_id.as_key(),
                    ...
                    if !brocode_apps_ready {
                        warn!(
                            plugin = result.plugin_id.as_key(),
                            "brocode_apps MCP not ready after plugin install; skipping appsNeedingAuth check"
                        );
                    }
                ...
                let (code, message, data) = match err {
                    ...
                    SteerInputError::ActiveTurnNotSteerable { turn_kind } => {
                        let message = match turn_kind {
                            brocode_protocol::protocol::NonSteerableTurnKind::Review => {
                                "cannot steer a review turn".to_string()
                            }
                            brocode_protocol::protocol::NonSteerableTurnKind::Compact => {
                                "cannot steer a compact turn".to_string()
                            }
                        };
                        let error = TurnError {
                            message: message.clone(),
                            brocode_error_info: Some(
    ...
    async fn prepare_realtime_conversation_thread(
        ...
        request_id: ConnectionRequestId,
        thread_id: &str,
    ) -> Option<(ThreadId, Arc<BrocodeThread>)> {
        let (thread_id, thread) = match self.load_thread(thread_id).await {
            Ok(v) => v,
            Err(error) => {
                self.outgoing.send_error(request_id, error).await;
    ...
    async fn start_inline_review(
        &self,
        request_id: &ConnectionRequestId,
        parent_thread: Arc<BrocodeThread>,
    ...
    async fn start_detached_review(
        ...
        let rollout_path = if let Some(path) = parent_thread.rollout_path() {
            ...
            find_thread_path_by_id_str(&self.config.brocode_home, &parent_thread_id.to_string())
                .await
                .map_err(|err| JSONRPCErrorError {
                    code: INTERNAL_ERROR_CODE,
    ...
    async fn ensure_listener_task_running(
        &self,
        conversation_id: ThreadId,
        conversation: Arc<BrocodeThread>,
            ...
            let setup_result = match derived_config {
                Ok(config) => {
                    let setup_request = WindowsSandboxSetupRequest {
                        ...
                        brocode_home: config.brocode_home.clone(),
                        active_profile: config.active_profile.clone(),
                    };
                    brocode_core::windows_sandbox::run_windows_sandbox_setup(setup_request).await
                }
...
async fn handle_pending_thread_resume_request(
    ...
    match find_thread_name_by_id(brocode_home, &conversation_id).await {
...
fn collect_resume_override_mismatches(
    ...
    if let Some(requested_review_policy) = request.approvals_reviewer.as_ref() {
        let active_review_policy: brocode_app_server_protocol::ApprovalsReviewer =
    ...
    if let Some(requested_sandbox) = request.sandbox.as_ref() {
        let sandbox_matches = matches!(
            ...
            (
                ...
                brocode_protocol::protocol::SandboxPolicy::ReadOnly { .. }
            ) | (
                SandboxMode::WorkspaceWrite,
                brocode_protocol::protocol::SandboxPolicy::WorkspaceWrite { .. }
            ) | (
                SandboxMode::DangerFullAccess,
                brocode_protocol::protocol::SandboxPolicy::DangerFullAccess
            ) | (
                SandboxMode::DangerFullAccess,
                brocode_protocol::protocol::SandboxPolicy::ExternalSandbox { .. }
            )
        );
        if !sandbox_matches {
            mismatch_details.push(format!(
...
fn skills_to_info(
    skills: &[brocode_core::skills::SkillMetadata],
    disabled_paths: &std::collections::HashSet<PathBuf>,
) -> Vec<brocode_app_server_protocol::SkillMetadata> {
    skills
        .iter()
        .map(|skill| {
            let enabled = !disabled_paths.contains(&skill.path_to_skills_md);
            brocode_app_server_protocol::SkillMetadata {
                name: skill.name.clone(),
                description: skill.description.clone(),
                short_description: skill.short_description.clone(),
                interface: skill.interface.clone().map(|interface| {
                    brocode_app_server_protocol::SkillInterface {
                        display_name: interface.display_name,
                ...
                dependencies: skill.dependencies.clone().map(|dependencies| {
                    brocode_app_server_protocol::SkillDependencies {
                        tools: dependencies
                            .tools
                            .into_iter()
                            .map(|tool| brocode_app_server_protocol::SkillToolDependency {
                                r#type: tool.r#type,
                                value: tool.value,
                                description: tool.description,
...
fn plugin_interface_to_info(
    interface: brocode_core::plugins::PluginManifestInterface,
) -> PluginInterface {
    PluginInterface {
        display_name: interface.display_name,
        short_description: interface.short_description,
...
fn errors_to_info(
    errors: &[brocode_core::skills::SkillError],
) -> Vec<brocode_app_server_protocol::SkillErrorInfo> {
    errors
        .iter()
        .map(|err| brocode_app_server_protocol::SkillErrorInfo {
            path: err.path.clone(),
...
fn replace_cloud_requirements_loader(
    ...
    let loader = cloud_requirements_loader(auth_manager, chatgpt_base_url, brocode_home);
...
async fn sync_default_client_residency_requirement(
    ...
    let loader = cloud_requirements
        ...
        .map(|guard| guard.clone())
        .unwrap_or_default();
    match brocode_core::config::ConfigBuilder::default()
...
async fn derive_config_from_params(
    ...
    let mut config = brocode_core::config::ConfigBuilder::default()
        .brocode_home(brocode_home.to_path_buf())
...
async fn summary_from_thread_list_item(
    ...
    if let Some(thread_id) = it.thread_id {
        ...
        let source = with_thread_spawn_agent_metadata(
            it.source
                .unwrap_or(brocode_protocol::protocol::SessionSource::Unknown),
...
fn extract_conversation_summary(
    ...
    let preview = head
        ...
        .find_map(|item| match brocode_core::parse_turn_item(&item) {
...
fn preview_from_rollout_items(items: &[RolloutItem]) -> String {
    items
        ...
        .find_map(|item| match item {
            RolloutItem::ResponseItem(item) => match brocode_core::parse_turn_item(item) {
                Some(brocode_protocol::items::TurnItem::UserMessage(user)) => Some(user.message()),
                _ => None,
            },
            _ => None,
        })
...
fn with_thread_spawn_agent_metadata(
    source: brocode_protocol::protocol::SessionSource,
    agent_nickname: Option<String>,
    agent_role: Option<String>,
) -> brocode_protocol::protocol::SessionSource {
    if agent_nickname.is_none() && agent_role.is_none() {
        return source;
    }

    match source {
        brocode_protocol::protocol::SessionSource::SubAgent(
            brocode_protocol::protocol::SubAgentSource::ThreadSpawn {
                parent_thread_id,
                depth,
                agent_path,
...
mod tests {
    ...
    use anyhow::Result;
    use brocode_app_server_protocol::ServerRequestPayload;
    ...
    use brocode_protocol::protocol::SubAgentSource;
    ...
    fn collect_resume_override_mismatches_includes_service_tier() {
        let request = ThreadResumeParams {
            ...
            model: None,
            model_provider: None,
            service_tier: Some(Some(brocode_protocol::config_types::ServiceTier::Fast)),
            cwd: None,
        ...
        let config_snapshot = ThreadConfigSnapshot {
            ...
            service_tier: Some(brocode_protocol::config_types::ServiceTier::Flex),
            approval_policy: brocode_protocol::protocol::AskForApproval::OnRequest,
            approvals_reviewer: brocode_protocol::config_types::ApprovalsReviewer::User,
            sandbox_policy: brocode_protocol::protocol::SandboxPolicy::DangerFullAccess,
    ...
    fn test_thread_metadata(
        ...
        let mut builder = ThreadMetadataBuilder::new(
            ...
            Utc::now(),
            brocode_protocol::protocol::SessionSource::default(),
        );
    ...
    async fn read_summary_from_rollout_returns_empty_preview_when_no_user_message() -> Result<()> {
        use brocode_protocol::protocol::RolloutItem;
        use brocode_protocol::protocol::RolloutLine;
        use brocode_protocol::protocol::SessionMetaLine;
        use std::fs;
        use std::fs::FileTimes;
    ...
    async fn removing_thread_state_clears_listener_and_active_turn_history() -> Result<()> {
            ...
            .expect("connection should be live");
        {
            ...
            state.track_current_turn_event(&EventMsg::TurnStarted(
                brocode_protocol::protocol::TurnStartedEvent {
                    turn_id: "turn-1".to_string(),
