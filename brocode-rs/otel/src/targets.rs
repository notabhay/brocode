pub(crate) const OTEL_TARGET_PREFIX: &str = "brocode_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "brocode_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "brocode_otel.trace_safe";
