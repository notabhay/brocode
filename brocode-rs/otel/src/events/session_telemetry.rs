...
use brocode_api::ApiError;
use brocode_api::ResponseEvent;
...
pub struct AuthEnvTelemetryMetadata {
    ...
    pub brocode_api_key_env_present: bool,
    pub brocode_api_key_env_enabled: bool,
...
impl SessionTelemetry {
    ...
    pub fn conversation_starts(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "brocode.conversation_starts",
                provider_name = %provider_name,
                auth.env_openai_api_key_present = self.metadata.auth_env.openai_api_key_env_present,
                auth.env_brocode_api_key_present = self.metadata.auth_env.brocode_api_key_env_present,
                auth.env_brocode_api_key_enabled = self.metadata.auth_env.brocode_api_key_env_enabled,
    ...
    pub fn record_websocket_connect(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "brocode.websocket_connect",
                duration_ms = %duration.as_millis(),
                http.response.status_code = status,
                success = success_str,
                error.message = error,
    ...
    pub fn record_websocket_request(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "brocode.websocket_request",
                duration_ms = %duration.as_millis(),
                success = success_str,
                error.message = error,
                auth.env_openai_api_key_present = self.metadata.auth_env.openai_api_key_env_present,
    ...
    pub fn record_auth_recovery(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "brocode.auth_recovery",
                auth.mode = mode,
                auth.step = step,
    ...
    pub fn record_websocket_event(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "brocode.websocket_event",
                event.kind = %kind_str,
                duration_ms = %duration.as_millis(),
                success = success_str,
    ...
    pub fn user_prompt(&self, items: &[UserInput]) {
        ...
        log_event!(
            self,
            event.name = "brocode.user_prompt",
    ...
    pub fn tool_decision(
        ...
        log_event!(
            self,
            event.name = "brocode.tool_decision",
            tool_name = %tool_name,
            call_id = %call_id,
    ...
    pub fn log_tool_failed(&self, tool_name: &str, error: &str) {
        log_event!(
            self,
            event.name = "brocode.tool_result",
            tool_name = %tool_name,
