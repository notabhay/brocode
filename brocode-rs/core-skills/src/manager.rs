...
use brocode_config::SkillsConfig;
...
impl SkillsManager {
    pub fn new(brocode_home: PathBuf, bundled_skills_enabled: bool) -> Self {
    ...
    pub fn new_with_restriction_product(
        ...
        if !bundled_skills_enabled {
            ...
            uninstall_system_skills(&manager.brocode_home);
        } else if let Err(err) = install_system_skills(&manager.brocode_home) {
...
pub fn bundled_skills_enabled_from_stack(
    config_layer_stack: &brocode_config::ConfigLayerStack,
) -> bool {
