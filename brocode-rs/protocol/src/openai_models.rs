//! Shared model metadata types exchanged between Brocode services and clients.
//!
...
/// Metadata describing a Brocode-supported model.
#[derive(Debug, Clone, Deserialize, Serialize, TS, JsonSchema, PartialEq)]
...
/// Model metadata returned by the Brocode backend `/models` endpoint.
