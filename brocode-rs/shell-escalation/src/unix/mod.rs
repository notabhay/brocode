...
//! `EscalateRequest` over the inherited `BROCODE_ESCALATE_SOCKET`, and the server decides whether to
...
//! specified by the `BROCODE_ESCALATE_SOCKET` environment variable to _send_ escalation requests,
...
pub use brocode_protocol::approvals::EscalationPermissions;
pub use brocode_protocol::approvals::Permissions;
