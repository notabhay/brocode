...
use brocode_app_server_protocol::ClientResponse;
...
impl AnalyticsReducer {
    ...
    fn ingest_app_used(&mut self, input: AppUsedInput, out: &mut Vec<TrackEventRequest>) {
        ...
        out.push(TrackEventRequest::AppUsed(BrocodeAppUsedEventRequest {
    ...
    fn ingest_plugin_state_changed(
        ...
        let event = BrocodePluginEventRequest {
            ...
            event_params: brocode_plugin_metadata(plugin),
        };
...
fn plugin_state_event_type(state: PluginState) -> &'static str {
    match state {
        PluginState::Installed => "brocode_plugin_installed",
        PluginState::Uninstalled => "brocode_plugin_uninstalled",
        PluginState::Enabled => "brocode_plugin_enabled",
        PluginState::Disabled => "brocode_plugin_disabled",
    }
}
