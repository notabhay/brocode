...
use brocode_client::RequestTelemetry;
...
impl<T: HttpTransport, A: AuthProvider> ModelsClient<T, A> {
    ...
    fn append_client_version_query(req: &mut brocode_client::Request, client_version: &str) {
...
mod tests {
    ...
    async fn appends_client_version_query() {
        ...
        let client = ModelsClient::new(
            transport.clone(),
            provider("https://example.com/api/brocode"),
            DummyAuth,
        );
        ...
        assert_eq!(
            url,
            "https://example.com/api/brocode/models?client_version=0.99.0"
        );
    }
