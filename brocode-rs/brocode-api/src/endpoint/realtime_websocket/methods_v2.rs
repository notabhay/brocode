    ...
    match session_mode {
        RealtimeSessionMode::Conversational => SessionUpdateSession {
            ...
            tools: Some(vec![SessionFunctionTool {
                ...
                name: REALTIME_V2_BROCODE_TOOL_NAME.to_string(),
                description: REALTIME_V2_BROCODE_TOOL_DESCRIPTION.to_string(),
                parameters: json!({
                    "type": "object",
                    "properties": {
                        "prompt": {
                            "type": "string",
                            "description": "The user request to delegate to Brocode."
                        }
                    },
                    "required": ["prompt"],
