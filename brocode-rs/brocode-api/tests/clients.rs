...
use brocode_api::Provider;
use brocode_api::ResponsesApiRequest;
use brocode_api::ResponsesClient;
use brocode_api::ResponsesOptions;
use brocode_api::requests::responses::Compression;
use brocode_client::HttpTransport;
use brocode_client::Request;
use brocode_client::Response;
use brocode_client::StreamResponse;
...
fn provider(name: &str) -> Provider {
    Provider {
        ...
        query_params: None,
        headers: HeaderMap::new(),
        retry: brocode_api::provider::RetryConfig {
            max_attempts: 1,
