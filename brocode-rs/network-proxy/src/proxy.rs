...
#[command(
    name = "brocode-network-proxy",
    about = "Brocode network sandbox proxy"
)]
pub struct Args {}
...
impl NetworkProxyBuilder {
    ...
    pub fn managed_by_brocode(mut self, managed_by_brocode: bool) -> Self {
        self.managed_by_brocode = managed_by_brocode;
        self
    }
...
pub const ALLOW_LOCAL_BINDING_ENV_KEY: &str = "BROCODE_NETWORK_ALLOW_LOCAL_BINDING";
...
mod tests {
    ...
    #[tokio::test]
    async fn non_brocode_managed_proxy_builder_uses_configured_ports() {
