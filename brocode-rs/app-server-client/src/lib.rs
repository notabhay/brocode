...
//!
//! This crate wraps [`brocode_app_server::in_process`] behind a single async API
...
//! [`InProcessClientHandle`](brocode_app_server::in_process::InProcessClientHandle),
...
pub use brocode_app_server::in_process::DEFAULT_IN_PROCESS_CHANNEL_CAPACITY;
pub use brocode_app_server::in_process::InProcessServerEvent;
use brocode_app_server::in_process::InProcessStartArgs;
...
use brocode_app_server_protocol::Result as JsonRpcResult;
...
pub struct InProcessClientStartArgs {
    ...
    pub feedback: BrocodeFeedback,
    /// Startup warnings emitted after initialize succeeds.
    pub config_warnings: Vec<ConfigWarningNotification>,
    /// Session source recorded in app-server thread metadata.
    pub session_source: SessionSource,
    /// Whether auth loading should honor the `BROCODE_API_KEY` environment variable.
    pub enable_brocode_api_key_env: bool,
...
impl InProcessClientStartArgs {
    ...
    fn into_runtime_start_args(self) -> InProcessStartArgs {
        ...
        InProcessStartArgs {
            ...
            enable_brocode_api_key_env: self.enable_brocode_api_key_env,
            initialize,
...
/// - [`brocode_app_server::in_process::InProcessClientHandle`], which speaks to
...
impl InProcessAppServerClient {
    ...
    pub async fn start(args: InProcessClientStartArgs) -> IoResult<Self> {
        ...
        let mut handle =
            brocode_app_server::in_process::start(args.into_runtime_start_args()).await?;
...
mod tests {
    ...
    use brocode_app_server_protocol::ServerNotification;
    use brocode_app_server_protocol::SessionSource as ApiSessionSource;
    ...
    async fn start_test_client_with_capacity(
        ...
        InProcessAppServerClient::start(InProcessClientStartArgs {
            ...
            client_name: "brocode-app-server-client-test".to_string(),
    ...
    fn command_execution_output_delta_notification(delta: &str) -> ServerNotification {
        ServerNotification::CommandExecutionOutputDelta(
            brocode_app_server_protocol::CommandExecutionOutputDeltaNotification {
    ...
    fn item_completed_notification(text: &str) -> ServerNotification {
        ServerNotification::ItemCompleted(brocode_app_server_protocol::ItemCompletedNotification {
            thread_id: "thread".to_string(),
            turn_id: "turn".to_string(),
            item: brocode_app_server_protocol::ThreadItem::AgentMessage {
                id: "item".to_string(),
                text: text.to_string(),
                phase: None,
    ...
    fn turn_completed_notification() -> ServerNotification {
        ServerNotification::TurnCompleted(brocode_app_server_protocol::TurnCompletedNotification {
            thread_id: "thread".to_string(),
            turn: brocode_app_server_protocol::Turn {
                id: "turn".to_string(),
                items: Vec::new(),
    ...
    async fn typed_request_reports_json_rpc_errors() {
        ...
        let err = client
            .request_typed::<ConfigRequirementsReadResponse>(ClientRequest::ThreadRead {
                ...
                params: brocode_app_server_protocol::ThreadReadParams {
    ...
    async fn threads_started_via_app_server_are_visible_through_typed_requests() {
        ...
        let response: ThreadStartResponse = client
            ...
            .expect("thread/start should succeed");
        let read = client
            .request_typed::<brocode_app_server_protocol::ThreadReadResponse>(
    ...
    async fn forward_in_process_event_preserves_transcript_notifications_under_backpressure() {
        ...
        assert!(matches!(
            ...
            InProcessServerEvent::ServerNotification(ServerNotification::ItemCompleted(
                ...
                &notification.item,
                brocode_app_server_protocol::ThreadItem::AgentMessage { text, .. } if text == "hello"
            )
        ));
        assert!(matches!(
            &events[4],
            InProcessServerEvent::ServerNotification(ServerNotification::TurnCompleted(
                notification
            )) if notification.turn.status == brocode_app_server_protocol::TurnStatus::Completed
        ));
    }
    ...
    async fn remote_typed_request_roundtrip_works() {
        ...
        let response: GetAccountResponse = client
            .request_typed(ClientRequest::GetAccount {
                request_id: RequestId::Integer(1),
                params: brocode_app_server_protocol::GetAccountParams {
                    refresh_token: false,
                },
            })
            .await
        ...
        for event in &remaining_events {
            match event {
                ...
                AppServerEvent::ServerNotification(ServerNotification::TurnCompleted(
                    ...
                    == brocode_app_server_protocol::TurnStatus::Completed =>
                {
    ...
    fn event_requires_delivery_marks_transcript_and_terminal_events() {
        assert!(event_requires_delivery(
            &InProcessServerEvent::ServerNotification(
                brocode_app_server_protocol::ServerNotification::TurnCompleted(
                    brocode_app_server_protocol::TurnCompletedNotification {
                        thread_id: "thread".to_string(),
                        turn: brocode_app_server_protocol::Turn {
                            id: "turn".to_string(),
                            items: Vec::new(),
        ...
        assert!(event_requires_delivery(
            &InProcessServerEvent::ServerNotification(
                brocode_app_server_protocol::ServerNotification::AgentMessageDelta(
                    brocode_app_server_protocol::AgentMessageDeltaNotification {
                        thread_id: "thread".to_string(),
                        turn_id: "turn".to_string(),
                        item_id: "item".to_string(),
        ...
        assert!(event_requires_delivery(
            &InProcessServerEvent::ServerNotification(
                brocode_app_server_protocol::ServerNotification::ItemCompleted(
                    brocode_app_server_protocol::ItemCompletedNotification {
                        thread_id: "thread".to_string(),
                        turn_id: "turn".to_string(),
                        item: brocode_app_server_protocol::ThreadItem::AgentMessage {
                            id: "item".to_string(),
        ...
        assert!(!event_requires_delivery(
            &InProcessServerEvent::ServerNotification(
                brocode_app_server_protocol::ServerNotification::CommandExecutionOutputDelta(
                    brocode_app_server_protocol::CommandExecutionOutputDeltaNotification {
                        thread_id: "thread".to_string(),
                        turn_id: "turn".to_string(),
                        item_id: "item".to_string(),
