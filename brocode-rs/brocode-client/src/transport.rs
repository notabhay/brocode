use crate::default_client::BrocodeHttpClient;
use crate::default_client::BrocodeRequestBuilder;
...
impl ReqwestTransport {
    pub fn new(client: reqwest::Client) -> Self {
        Self {
            client: BrocodeHttpClient::new(client),
        }
    }

    fn build(&self, req: Request) -> Result<BrocodeRequestBuilder, TransportError> {
        let Request {
            method,
            url,
            mut headers,
