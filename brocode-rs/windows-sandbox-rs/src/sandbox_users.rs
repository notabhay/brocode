...
use brocode_windows_sandbox::dpapi_protect;
...
pub const SANDBOX_USERS_GROUP: &str = "BrocodeSandboxUsers";
const SANDBOX_USERS_GROUP_COMMENT: &str = "Brocode sandbox internal group (managed)";
...
fn write_secrets(
    ...
    let sandbox_dir = sandbox_dir(brocode_home);
    ...
    let secrets_dir = sandbox_secrets_dir(brocode_home);
