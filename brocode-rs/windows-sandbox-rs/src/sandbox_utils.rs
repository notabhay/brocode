...
//! brocode home directory creation and git safe.directory injection so sandboxed
...
/// Ensure the sandbox brocode home directory exists.
pub fn ensure_brocode_home_exists(p: &Path) -> Result<()> {
