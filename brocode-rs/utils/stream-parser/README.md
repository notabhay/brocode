# brocode-utils-stream-parser

Small, dependency-free utilities for parsing streamed text incrementally.

**Disclaimer**: This code is pretty complex and Brocode did not manage to write it so before updating the code, make
sure to deeply understand it and don't blindly trust Brocode on it. Feel free to update the documentation as you
modify the code
...
```rust
use brocode_utils_stream_parser::CitationStreamParser;
use brocode_utils_stream_parser::StreamTextParser;
...
```rust
use brocode_utils_stream_parser::CitationStreamParser;
use brocode_utils_stream_parser::Utf8StreamParser;

# fn demo() -> Result<(), brocode_utils_stream_parser::Utf8StreamParserError> {
...
```rust
use brocode_utils_stream_parser::InlineHiddenTagParser;
use brocode_utils_stream_parser::InlineTagSpec;
use brocode_utils_stream_parser::StreamTextParser;
