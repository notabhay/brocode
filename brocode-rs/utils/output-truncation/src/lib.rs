//! Helpers for truncating tool and exec output using [`TruncationPolicy`](brocode_protocol::protocol::TruncationPolicy).

use brocode_protocol::models::FunctionCallOutputContentItem;
pub use brocode_utils_string::approx_bytes_for_tokens;
pub use brocode_utils_string::approx_token_count;
pub use brocode_utils_string::approx_tokens_from_byte_count;
use brocode_utils_string::truncate_middle_chars;
use brocode_utils_string::truncate_middle_with_token_budget;

pub use brocode_protocol::protocol::TruncationPolicy;
