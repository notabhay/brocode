...
pub struct InitializeResponse {
    ...
    /// Absolute path to the server's $BROCODE_HOME directory.
    pub brocode_home: AbsolutePathBuf,
...
pub struct ApplyPatchApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [brocode_protocol::protocol::PatchApplyBeginEvent]
    /// and [brocode_protocol::protocol::PatchApplyEndEvent].
    pub call_id: String,
...
pub struct ExecCommandApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [brocode_protocol::protocol::ExecCommandBeginEvent]
    /// and [brocode_protocol::protocol::ExecCommandEndEvent].
    pub call_id: String,
