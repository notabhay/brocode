...
use brocode_experimental_api_macros::ExperimentalApi;
use brocode_protocol::account::PlanType;
use brocode_protocol::approvals::ElicitationRequest as CoreElicitationRequest;
use brocode_protocol::approvals::ExecApprovalRequestSkillMetadata as CoreExecApprovalRequestSkillMetadata;
use brocode_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use brocode_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use brocode_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use brocode_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use brocode_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use brocode_protocol::config_types::ApprovalsReviewer as CoreApprovalsReviewer;
use brocode_protocol::config_types::CollaborationMode;
use brocode_protocol::config_types::CollaborationModeMask as CoreCollaborationModeMask;
...
use brocode_protocol::config_types::ReasoningSummary;
use brocode_protocol::config_types::SandboxMode as CoreSandboxMode;
use brocode_protocol::config_types::ServiceTier;
use brocode_protocol::config_types::Verbosity;
use brocode_protocol::config_types::WebSearchMode;
use brocode_protocol::config_types::WebSearchToolConfig;
use brocode_protocol::items::AgentMessageContent as CoreAgentMessageContent;
use brocode_protocol::items::TurnItem as CoreTurnItem;
use brocode_protocol::mcp::Resource as McpResource;
use brocode_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use brocode_protocol::mcp::Tool as McpTool;
use brocode_protocol::memory_citation::MemoryCitation as CoreMemoryCitation;
use brocode_protocol::memory_citation::MemoryCitationEntry as CoreMemoryCitationEntry;
use brocode_protocol::models::FileSystemPermissions as CoreFileSystemPermissions;
use brocode_protocol::models::MacOsAutomationPermission as CoreMacOsAutomationPermission;
use brocode_protocol::models::MacOsContactsPermission as CoreMacOsContactsPermission;
use brocode_protocol::models::MacOsPreferencesPermission as CoreMacOsPreferencesPermission;
use brocode_protocol::models::MacOsSeatbeltProfileExtensions as CoreMacOsSeatbeltProfileExtensions;
use brocode_protocol::models::MessagePhase;
use brocode_protocol::models::NetworkPermissions as CoreNetworkPermissions;
use brocode_protocol::models::PermissionProfile as CorePermissionProfile;
use brocode_protocol::models::ResponseItem;
use brocode_protocol::openai_models::InputModality;
use brocode_protocol::openai_models::ModelAvailabilityNux as CoreModelAvailabilityNux;
use brocode_protocol::openai_models::ReasoningEffort;
use brocode_protocol::openai_models::default_input_modalities;
use brocode_protocol::parse_command::ParsedCommand as CoreParsedCommand;
use brocode_protocol::plan_tool::PlanItemArg as CorePlanItemArg;
use brocode_protocol::plan_tool::StepStatus as CorePlanStepStatus;
use brocode_protocol::protocol::AgentStatus as CoreAgentStatus;
use brocode_protocol::protocol::AskForApproval as CoreAskForApproval;
use brocode_protocol::protocol::BrocodeErrorInfo as CoreBrocodeErrorInfo;
use brocode_protocol::protocol::CreditsSnapshot as CoreCreditsSnapshot;
use brocode_protocol::protocol::ExecCommandSource as CoreExecCommandSource;
use brocode_protocol::protocol::ExecCommandStatus as CoreExecCommandStatus;
use brocode_protocol::protocol::GranularApprovalConfig as CoreGranularApprovalConfig;
use brocode_protocol::protocol::GuardianRiskLevel as CoreGuardianRiskLevel;
use brocode_protocol::protocol::HookEventName as CoreHookEventName;
use brocode_protocol::protocol::HookExecutionMode as CoreHookExecutionMode;
use brocode_protocol::protocol::HookHandlerType as CoreHookHandlerType;
use brocode_protocol::protocol::HookOutputEntry as CoreHookOutputEntry;
use brocode_protocol::protocol::HookOutputEntryKind as CoreHookOutputEntryKind;
use brocode_protocol::protocol::HookRunStatus as CoreHookRunStatus;
use brocode_protocol::protocol::HookRunSummary as CoreHookRunSummary;
use brocode_protocol::protocol::HookScope as CoreHookScope;
use brocode_protocol::protocol::ModelRerouteReason as CoreModelRerouteReason;
use brocode_protocol::protocol::NetworkAccess as CoreNetworkAccess;
use brocode_protocol::protocol::NonSteerableTurnKind as CoreNonSteerableTurnKind;
...
use brocode_protocol::protocol::RateLimitWindow as CoreRateLimitWindow;
use brocode_protocol::protocol::ReadOnlyAccess as CoreReadOnlyAccess;
use brocode_protocol::protocol::RealtimeAudioFrame as CoreRealtimeAudioFrame;
use brocode_protocol::protocol::RealtimeConversationVersion;
use brocode_protocol::protocol::ReviewDecision as CoreReviewDecision;
use brocode_protocol::protocol::SessionSource as CoreSessionSource;
use brocode_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use brocode_protocol::protocol::SkillErrorInfo as CoreSkillErrorInfo;
use brocode_protocol::protocol::SkillInterface as CoreSkillInterface;
use brocode_protocol::protocol::SkillMetadata as CoreSkillMetadata;
use brocode_protocol::protocol::SkillScope as CoreSkillScope;
use brocode_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
use brocode_protocol::protocol::SubAgentSource as CoreSubAgentSource;
use brocode_protocol::protocol::TokenUsage as CoreTokenUsage;
use brocode_protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
use brocode_protocol::request_permissions::PermissionGrantScope as CorePermissionGrantScope;
use brocode_protocol::request_permissions::RequestPermissionProfile as CoreRequestPermissionProfile;
use brocode_protocol::user_input::ByteRange as CoreByteRange;
use brocode_protocol::user_input::TextElement as CoreTextElement;
use brocode_protocol::user_input::UserInput as CoreUserInput;
...
/// This translation layer make sure that we expose brocode error code in camel case.
///
/// When an upstream HTTP status is available (for example, from the Responses API or a provider),
/// it is forwarded in `httpStatusCode` on the relevant `brocodeErrorInfo` variant.
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, Eq, JsonSchema, TS)]
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub enum BrocodeErrorInfo {
...
impl From<CoreBrocodeErrorInfo> for BrocodeErrorInfo {
    fn from(value: CoreBrocodeErrorInfo) -> Self {
        match value {
            CoreBrocodeErrorInfo::ContextWindowExceeded => BrocodeErrorInfo::ContextWindowExceeded,
            CoreBrocodeErrorInfo::UsageLimitExceeded => BrocodeErrorInfo::UsageLimitExceeded,
            CoreBrocodeErrorInfo::ServerOverloaded => BrocodeErrorInfo::ServerOverloaded,
            CoreBrocodeErrorInfo::HttpConnectionFailed { http_status_code } => {
                BrocodeErrorInfo::HttpConnectionFailed { http_status_code }
            }
            CoreBrocodeErrorInfo::ResponseStreamConnectionFailed { http_status_code } => {
                BrocodeErrorInfo::ResponseStreamConnectionFailed { http_status_code }
            }
            CoreBrocodeErrorInfo::InternalServerError => BrocodeErrorInfo::InternalServerError,
            CoreBrocodeErrorInfo::Unauthorized => BrocodeErrorInfo::Unauthorized,
            CoreBrocodeErrorInfo::BadRequest => BrocodeErrorInfo::BadRequest,
            CoreBrocodeErrorInfo::ThreadRollbackFailed => BrocodeErrorInfo::ThreadRollbackFailed,
            CoreBrocodeErrorInfo::SandboxError => BrocodeErrorInfo::SandboxError,
            CoreBrocodeErrorInfo::ResponseStreamDisconnected { http_status_code } => {
                BrocodeErrorInfo::ResponseStreamDisconnected { http_status_code }
            }
            CoreBrocodeErrorInfo::ResponseTooManyFailedAttempts { http_status_code } => {
                BrocodeErrorInfo::ResponseTooManyFailedAttempts { http_status_code }
            }
            CoreBrocodeErrorInfo::ActiveTurnNotSteerable { turn_kind } => {
                BrocodeErrorInfo::ActiveTurnNotSteerable {
                    turn_kind: turn_kind.into(),
                }
            }
            CoreBrocodeErrorInfo::Other => BrocodeErrorInfo::Other,
        }
    }
}
...
v2_enum_from_core!(
    pub enum ReviewDelivery from brocode_protocol::protocol::ReviewDelivery {
        Inline, Detached
    }
);

v2_enum_from_core!(
    pub enum McpAuthStatus from brocode_protocol::protocol::McpAuthStatus {
        Unsupported,
        NotLoggedIn,
        BearerToken,
        OAuth
...
pub enum ConfigLayerSource {
    ...
    /// Path to a .brocode/ folder within a project. There could be multiple of
    /// these between `cwd` and the project/repo root.
    #[serde(rename_all = "camelCase")]
    #[ts(rename_all = "camelCase")]
    Project {
        dot_brocode_folder: AbsolutePathBuf,
    },
...
pub struct ExternalAgentConfigDetectParams {
    /// If true, include detection under the user's home (~/.claude, ~/.brocode, etc.).
    #[serde(default, skip_serializing_if = "std::ops::Not::not")]
...
impl SandboxPolicy {
    pub fn to_core(&self) -> brocode_protocol::protocol::SandboxPolicy {
        match self {
...
impl From<brocode_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: brocode_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            brocode_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            ...
            brocode_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
...
pub enum LoginAccountParams {
    ...
    /// The access token must contain the same scopes that Brocode-managed ChatGPT auth tokens have.
    ...
    ChatgptAuthTokens {
        ...
        ///
        /// When `null`, Brocode attempts to derive the plan type from access-token
...
pub enum ChatgptAuthTokensRefreshReason {
    /// Brocode attempted a backend request and received `401 Unauthorized`.
    Unauthorized,
}
...
pub struct ChatgptAuthTokensRefreshParams {
    ...
    /// Workspace/account identifier that Brocode was previously using.
    ///
...
pub struct GetAccountRateLimitsResponse {
    ...
    /// Multi-bucket view keyed by metered `limit_id` (for example, `brocode`).
...
pub struct ThreadStartParams {
    ...
    /// This is for internal use only (e.g. Brocode Cloud).
...
pub struct ThreadResumeParams {
    ...
    /// [UNSTABLE] FOR BROCODE CLOUD - DO NOT USE.
...
pub struct Thread {
    ...
    /// Origin of the thread (CLI, VSCode, brocode exec, brocode app-server, etc.).
...
pub struct TurnError {
    pub message: String,
    pub brocode_error_info: Option<BrocodeErrorInfo>,
    #[serde(default)]
...
impl From<brocode_protocol::models::WebSearchAction> for WebSearchAction {
    fn from(value: brocode_protocol::models::WebSearchAction) -> Self {
        match value {
            ...
            brocode_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
        }
    }
}
...
impl From<brocode_protocol::items::HookPromptFragment> for HookPromptFragment {
    fn from(value: brocode_protocol::items::HookPromptFragment) -> Self {
        Self {
            text: value.text,
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> brocode_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => brocode_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => brocode_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => brocode_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
...
pub struct McpServerElicitationRequestParams {
    pub thread_id: String,
    /// Active Brocode turn when this elicitation was observed, if app-server could correlate one.
    ///
...
impl From<DynamicToolCallOutputContentItem>
    for brocode_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{
...
mod tests {
    ...
    use brocode_protocol::items::ReasoningItem;
    use brocode_protocol::items::TurnItem;
    use brocode_protocol::items::UserMessageItem;
    use brocode_protocol::items::WebSearchItem;
    use brocode_protocol::models::WebSearchAction as CoreWebSearchAction;
    use brocode_protocol::protocol::NetworkAccess as CoreNetworkAccess;
    use brocode_protocol::protocol::ReadOnlyAccess as CoreReadOnlyAccess;
    use brocode_protocol::user_input::UserInput as CoreUserInput;
        ...
        let user_item = TurnItem::UserMessage(UserMessageItem {
            ...
            content: vec![
                ...
                CoreUserInput::Skill {
                    ...
                    path: PathBuf::from("/repo/.brocode/skills/skill-creator/SKILL.md"),
                },
    ...
    #[test]
    fn brocode_error_info_serializes_http_status_code_in_camel_case() {
        let value = BrocodeErrorInfo::ResponseTooManyFailedAttempts {
    ...
    #[test]
    fn brocode_error_info_serializes_active_turn_not_steerable_turn_kind_in_camel_case() {
        let value = BrocodeErrorInfo::ActiveTurnNotSteerable {
