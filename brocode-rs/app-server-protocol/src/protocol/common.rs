...
pub enum AuthMode {
    /// OpenAI API key provided by the caller and stored by Brocode.
    ApiKey,
    /// ChatGPT OAuth managed by Brocode (tokens persisted and refreshed by Brocode).
    Chatgpt,
...
/// Superset of [`brocode_file_search::FileMatch`]
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
...
server_notification_definitions! {
    ...
    /// This event is internal-only. Used by Brocode Cloud.
