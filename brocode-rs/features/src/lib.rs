...
pub enum Feature {
    ...
    ImageDetailOriginal,
    /// Compress request bodies (zstd) when sending streaming requests to brocode-backend.
...
impl Features {
    ...
    pub fn apps_enabled_for_auth(&self, auth: Option<&BrocodeAuth>) -> bool {
        self.enabled(Feature::Apps) && auth.is_some_and(BrocodeAuth::is_chatgpt_auth)
    }
...
pub const FEATURES: &[FeatureSpec] = &[
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            ...
            announcement: "NEW: JavaScript REPL is now available in /experimental. Enable it, then start a new chat or restart Brocode to use it.",
        },
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        id: Feature::BrocodeGitCommit,
        key: "brocode_git_commit",
        stage: Stage::UnderDevelopment,
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        ...
        stage: if cfg!(any(
            ...
            Stage::Experimental {
                ...
                menu_description: "Keep your computer awake while Brocode is running a thread.",
