#!/usr/bin/env python3
"""Install a skill from a GitHub repo path into $BROCODE_HOME/skills."""
...
def _tmp_root() -> str:
    base = os.path.join(tempfile.gettempdir(), "brocode")
    os.makedirs(base, exist_ok=True)
    return base


def _request(url: str) -> bytes:
    return github_request(url, "brocode-skill-install")
...
def _default_dest() -> str:
    return os.path.join(_brocode_home(), "skills")
