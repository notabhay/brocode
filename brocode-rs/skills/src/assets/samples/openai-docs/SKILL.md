...
4. Brocode: OpenAI's coding agent for software development that can write, understand, review, and debug code.
...
1. Run the install command yourself: `brocode mcp add openaiDeveloperDocs --url https://developers.openai.com/mcp`
...
4. Ask the user to restart Brocode.
