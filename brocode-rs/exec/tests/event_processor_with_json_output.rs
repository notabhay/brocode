...
use brocode_app_server_protocol::CollabAgentState as ApiCollabAgentState;
use brocode_app_server_protocol::CollabAgentStatus as ApiCollabAgentStatus;
use brocode_app_server_protocol::CollabAgentTool;
use brocode_app_server_protocol::CollabAgentToolCallStatus as ApiCollabAgentToolCallStatus;
use brocode_app_server_protocol::CommandAction;
use brocode_app_server_protocol::CommandExecutionSource;
use brocode_app_server_protocol::CommandExecutionStatus as ApiCommandExecutionStatus;
use brocode_app_server_protocol::ErrorNotification;
use brocode_app_server_protocol::FileUpdateChange as ApiFileUpdateChange;
...
use brocode_app_server_protocol::McpToolCallStatus as ApiMcpToolCallStatus;
use brocode_app_server_protocol::PatchApplyStatus as ApiPatchApplyStatus;
use brocode_app_server_protocol::PatchChangeKind as ApiPatchChangeKind;
...
use brocode_app_server_protocol::WebSearchAction as ApiWebSearchAction;
...
use brocode_exec::event_processor_with_jsonl_output::BrocodeStatus;
use brocode_exec::event_processor_with_jsonl_output::CollectedThreadEvents;
use brocode_exec::event_processor_with_jsonl_output::EventProcessorWithJsonOutput;
use brocode_exec::exec_events::AgentMessageItem;
use brocode_exec::exec_events::CollabAgentState;
use brocode_exec::exec_events::CollabAgentStatus;
use brocode_exec::exec_events::CollabTool;
use brocode_exec::exec_events::CollabToolCallItem;
use brocode_exec::exec_events::CollabToolCallStatus;
use brocode_exec::exec_events::CommandExecutionItem;
use brocode_exec::exec_events::CommandExecutionStatus;
use brocode_exec::exec_events::ErrorItem;
use brocode_exec::exec_events::FileChangeItem;
use brocode_exec::exec_events::FileUpdateChange as ExecFileUpdateChange;
use brocode_exec::exec_events::ItemCompletedEvent;
use brocode_exec::exec_events::ItemStartedEvent;
use brocode_exec::exec_events::ItemUpdatedEvent;
use brocode_exec::exec_events::McpToolCallItem;
use brocode_exec::exec_events::McpToolCallItemError;
use brocode_exec::exec_events::McpToolCallItemResult;
use brocode_exec::exec_events::McpToolCallStatus;
use brocode_exec::exec_events::PatchApplyStatus;
use brocode_exec::exec_events::PatchChangeKind;
use brocode_exec::exec_events::ReasoningItem;
use brocode_exec::exec_events::ThreadErrorEvent;
use brocode_exec::exec_events::ThreadEvent;
use brocode_exec::exec_events::ThreadItem as ExecThreadItem;
use brocode_exec::exec_events::ThreadItemDetails;
use brocode_exec::exec_events::ThreadStartedEvent;
use brocode_exec::exec_events::TodoItem;
use brocode_exec::exec_events::TodoListItem;
use brocode_exec::exec_events::TurnCompletedEvent;
use brocode_exec::exec_events::TurnFailedEvent;
use brocode_exec::exec_events::TurnStartedEvent;
use brocode_exec::exec_events::Usage;
use brocode_exec::exec_events::WebSearchItem;
...
fn session_configured_produces_thread_started_event() {
    let session_configured = SessionConfiguredEvent {
        ...
        forked_from_id: None,
        thread_name: None,
        model: "brocode-mini-latest".to_string(),
...
fn plan_update_emits_started_then_updated_then_completed() {
    ...
    assert_eq!(
        ...
        CollectedThreadEvents {
            ...
            status: BrocodeStatus::InitiateShutdown,
        }
    );
}
...
fn token_usage_update_is_emitted_on_turn_completion() {
    ...
    let usage_update =
        processor.collect_thread_events(ServerNotification::ThreadTokenUsageUpdated(
            brocode_app_server_protocol::ThreadTokenUsageUpdatedNotification {
                thread_id: "thread-1".to_string(),
                turn_id: "turn-1".to_string(),
...
fn failed_turn_clears_stale_final_message() {
    ...
    assert_eq!(collected.status, BrocodeStatus::Running);
    ...
    assert_eq!(collected.status, BrocodeStatus::InitiateShutdown);
...
fn model_reroute_surfaces_as_error_item() {
    ...
    let collected = processor.collect_thread_events(ServerNotification::ModelRerouted(
        brocode_app_server_protocol::ModelReroutedNotification {
            thread_id: "thread-1".to_string(),
            turn_id: "turn-1".to_string(),
            from_model: "gpt-5".to_string(),
            to_model: "gpt-5-mini".to_string(),
            reason: brocode_app_server_protocol::ModelRerouteReason::HighRiskCyberActivity,
        },
    ));
