...
//! - sensitive subpaths such as `.git` and `.brocode` remain read-only even when
...
/// inside a writable root (e.g., `.brocode -> ./decoy`). In that case we mount
...
mod tests {
    use super::*;
    use brocode_protocol::protocol::FileSystemAccessMode;
    use brocode_protocol::protocol::FileSystemPath;
    use brocode_protocol::protocol::FileSystemSandboxEntry;
    use brocode_protocol::protocol::FileSystemSandboxPolicy;
    use brocode_protocol::protocol::FileSystemSpecialPath;
    ...
    fn mounts_dev_before_writable_dev_binds() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                "/".to_string(),
                "/".to_string(),
                // Mask the default protected .brocode subpath under that writable
