...
//! orchestration and rollout scanning live in `brocode-core`.
...
pub const SQLITE_HOME_ENV: &str = "BROCODE_SQLITE_HOME";
...
pub const DB_ERROR_METRIC: &str = "brocode.db.error";
/// Metrics on backfill process. Tags: [status]
pub const DB_METRIC_BACKFILL: &str = "brocode.db.backfill";
/// Metrics on backfill duration. Tags: [status]
pub const DB_METRIC_BACKFILL_DURATION_MS: &str = "brocode.db.backfill.duration_ms";
