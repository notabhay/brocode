...
fn list_shows_empty_state() -> Result<()> {
    ...
    let mut cmd = brocode_command(brocode_home.path())?;
...
async fn list_and_get_render_expected_output() -> Result<()> {
    ...
    let mut add = brocode_command(brocode_home.path())?;
    add.args([
        "mcp",
        "add",
        "docs",
    ...
    let mut servers = load_global_mcp_servers(brocode_home.path()).await?;
    ...
    let mut list_cmd = brocode_command(brocode_home.path())?;
    ...
    let mut list_json_cmd = brocode_command(brocode_home.path())?;
    ...
    let mut get_cmd = brocode_command(brocode_home.path())?;
    ...
    assert!(stdout.contains("remove: brocode mcp remove docs"));

    let mut get_json_cmd = brocode_command(brocode_home.path())?;
    get_json_cmd
