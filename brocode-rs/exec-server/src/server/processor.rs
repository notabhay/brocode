    ...
    while let Some(event) = incoming_rx.recv().await {
        match event {
            ...
            JsonRpcConnectionEvent::Message(message) => match message {
                brocode_app_server_protocol::JSONRPCMessage::Request(request) => {
                ...
                brocode_app_server_protocol::JSONRPCMessage::Notification(notification) => {
                ...
                brocode_app_server_protocol::JSONRPCMessage::Response(response) => {
                    warn!(
                ...
                brocode_app_server_protocol::JSONRPCMessage::Error(error) => {
                    warn!(
