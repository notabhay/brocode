...
pub const BROCODE_EXEC_SERVER_URL_ENV_VAR: &str = "BROCODE_EXEC_SERVER_URL";
...
impl EnvironmentManager {
    ...
    pub fn from_env() -> Self {
        Self::new(std::env::var(BROCODE_EXEC_SERVER_URL_ENV_VAR).ok())
    }
        ...
        let remote_exec_server_client = if let Some(url) = &exec_server_url {
            Some(
                ExecServerClient::connect_websocket(RemoteExecServerConnectArgs {
                    ...
                    client_name: "brocode-environment".to_string(),
