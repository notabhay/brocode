...
async fn stdio_server_round_trip() -> anyhow::Result<()> {
    ...
    let begin_event = wait_for_event(&fixture.brocode, |ev| {
    ...
    let end_event = wait_for_event(&fixture.brocode, |ev| {
    ...
    wait_for_event(&fixture.brocode, |ev| {
...
async fn stdio_image_responses_round_trip() -> anyhow::Result<()> {
    ...
    loop {
        fixture.brocode.submit(Op::ListMcpTools).await?;
        ...
        ModelsResponse {
            models: vec![ModelInfo {
                ...
                supported_reasoning_levels: vec![ReasoningEffortPreset {
                    effort: brocode_protocol::openai_models::ReasoningEffort::Medium,
