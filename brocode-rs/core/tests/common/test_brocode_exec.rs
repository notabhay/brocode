...
pub struct TestBrocodeExecBuilder {
    home: TempDir,
    cwd: TempDir,
}

impl TestBrocodeExecBuilder {
    pub fn cmd(&self) -> assert_cmd::Command {
        let mut cmd = assert_cmd::Command::new(
            brocode_utils_cargo_bin::cargo_bin("brocode-exec")
...
pub fn test_brocode_exec() -> TestBrocodeExecBuilder {
    TestBrocodeExecBuilder {
