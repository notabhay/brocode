...
const SERVER_NAME: &str = "brocode-apps-test";
...
async fn mount_streamable_http_json_rpc(
    ...
    Mock::given(method("POST"))
        .and(path_regex("^/api/brocode/apps/?$"))
        .respond_with(BrocodeAppsJsonRpcResponder {
            connector_name,
...
struct BrocodeAppsJsonRpcResponder {
    connector_name: String,
    connector_description: String,
    searchable: bool,
}

impl Respond for BrocodeAppsJsonRpcResponder {
        ...
        match method {
            ...
            "tools/call" => {
                ...
                let starts_at = body
                    ...
                    .and_then(Value::as_str)
                    .unwrap_or_default();
                let brocode_apps_meta = body.pointer("/params/_meta/_brocode_apps").cloned();
                ...
                ResponseTemplate::new(200).set_body_json(json!({
                    ...
                    "result": {
                        ...
                        "structuredContent": {
                            "_brocode_apps": brocode_apps_meta,
                        },
                        "isError": false
                    }
                }))
