...
pub const BROCODE_THREAD_ID_ENV_VAR: &str = "BROCODE_THREAD_ID";
...
///
/// `BROCODE_THREAD_ID` is injected when a thread id is provided, even when
/// `include_only` is set.
pub fn create_env(
    ...
    I: IntoIterator<Item = (String, String)>,
{
    ...
    if let Some(thread_id) = thread_id {
        env_map.insert(BROCODE_THREAD_ID_ENV_VAR.to_string(), thread_id.to_string());
    }
