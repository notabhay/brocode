...
pub(crate) mod tools {
    pub(crate) use brocode_tools::FreeformTool;
    pub(crate) use brocode_tools::FreeformToolFormat;
    pub(crate) use brocode_tools::ResponsesApiTool;
    pub(crate) use brocode_tools::ToolSearchOutputTool;
    pub(crate) use brocode_tools::ToolSpec;
}
