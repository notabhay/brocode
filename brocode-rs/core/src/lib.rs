//! Root of the `brocode-core` library.
...
pub use brocode::SteerInputError;
mod brocode_thread;
mod compact_remote;
pub use brocode_thread::BrocodeThread;
pub use brocode_thread::ThreadConfigSnapshot;
mod agent;
...
pub use brocode_utils_path::env;
...
pub use brocode_protocol::config_types::ModelProviderAuthInfo;
...
#[deprecated(note = "use BrocodeThread")]
pub type BrocodeConversation = BrocodeThread;
// Re-export common auth types for workspace consumers
pub use auth::AuthManager;
pub use auth::BrocodeAuth;
pub use brocode_analytics::AnalyticsEventsClient;
mod default_client_forwarding;

/// Default Brocode HTTP client headers and reqwest construction.
///
/// Implemented in [`brocode_login::default_client`]; this module re-exports that API for crates
/// that import `brocode_core::default_client`.
...
pub use brocode_rollout::state_db;
...
pub mod util;
pub(crate) use brocode_protocol::protocol;
pub(crate) use brocode_shell_command::bash;
pub(crate) use brocode_shell_command::is_dangerous_command;
pub(crate) use brocode_shell_command::is_safe_command;
pub(crate) use brocode_shell_command::parse_command;
pub(crate) use brocode_shell_command::powershell;

pub use brocode_sandboxing::get_platform_sandbox;
pub use brocode_tools::parse_tool_input_schema;
pub use client::ModelClient;
pub use client::ModelClientSession;
pub use client::X_BROCODE_TURN_METADATA_HEADER;
