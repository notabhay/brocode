...
use crate::brocode::get_last_assistant_message_from_turn;
...
async fn run_compact_task_inner(
    ...
    loop {
        ...
        match attempt_result {
            ...
            Err(BrocodeErr::Interrupted) => {
                return Err(BrocodeErr::Interrupted);
            }
            Err(e @ BrocodeErr::ContextWindowExceeded) => {
                if turn_input_len > 1 {
