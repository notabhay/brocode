...
pub use brocode_protocol::config_types::AltScreenMode;
pub use brocode_protocol::config_types::ApprovalsReviewer;
pub use brocode_protocol::config_types::ModeKind;
pub use brocode_protocol::config_types::Personality;
pub use brocode_protocol::config_types::ServiceTier;
pub use brocode_protocol::config_types::WebSearchMode;
...
pub struct McpServerConfig {
    ...
    /// When `false`, Brocode skips initializing this MCP server.
    #[serde(default = "default_enabled")]
    pub enabled: bool,

    /// When `true`, `brocode exec` exits with an error if this MCP server fails to initialize.
...
pub struct AnalyticsConfigToml {
    /// When `false`, disables analytics across Brocode product surfaces in this profile.
    pub enabled: Option<bool>,
}
...
pub struct FeedbackConfigToml {
    /// When `false`, disables the feedback flow across Brocode product surfaces.
    pub enabled: Option<bool>,
}
...
pub struct AppConfig {
    /// When `false`, Brocode does not surface this app.
    #[serde(default = "default_enabled")]
    pub enabled: bool,
...
/// (primarily the Brocode IDE extension). NOTE: these are different from
...
pub use brocode_config::BundledSkillsConfig;
pub use brocode_config::SkillConfig;
pub use brocode_config::SkillsConfig;
...
impl From<SandboxWorkspaceWrite> for brocode_app_server_protocol::SandboxSettings {
