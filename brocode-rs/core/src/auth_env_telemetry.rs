...
use crate::auth::BROCODE_API_KEY_ENV_VAR;
...
pub(crate) struct AuthEnvTelemetry {
    ...
    pub(crate) brocode_api_key_env_present: bool,
    pub(crate) brocode_api_key_env_enabled: bool,
...
impl AuthEnvTelemetry {
    pub(crate) fn to_otel_metadata(&self) -> AuthEnvTelemetryMetadata {
        AuthEnvTelemetryMetadata {
            ...
            brocode_api_key_env_present: self.brocode_api_key_env_present,
            brocode_api_key_env_enabled: self.brocode_api_key_env_enabled,
...
pub(crate) fn collect_auth_env_telemetry(
    ...
    brocode_api_key_env_enabled: bool,
) -> AuthEnvTelemetry {
    AuthEnvTelemetry {
        openai_api_key_env_present: env_var_present(OPENAI_API_KEY_ENV_VAR),
        brocode_api_key_env_present: env_var_present(BROCODE_API_KEY_ENV_VAR),
        brocode_api_key_env_enabled,
...
mod tests {
    ...
    fn collect_auth_env_telemetry_buckets_provider_env_key_name() {
        ...
        let telemetry =
            collect_auth_env_telemetry(&provider, /*brocode_api_key_env_enabled*/ false);
