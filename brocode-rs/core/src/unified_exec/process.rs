...
use brocode_exec_server::ExecProcess;
use brocode_exec_server::ReadResponse as ExecReadResponse;
use brocode_exec_server::StartedExecProcess;
use brocode_exec_server::WriteStatus;
use brocode_protocol::protocol::TruncationPolicy;
use brocode_sandboxing::SandboxType;
use brocode_utils_output_truncation::formatted_truncate_text;
use brocode_utils_pty::ExecCommandSession;
use brocode_utils_pty::SpawnedPty;
...
impl UnifiedExecProcess {
    ...
    pub(super) async fn from_spawned(
        ...
        let output_rx = brocode_utils_pty::combine_output_receivers(stdout_rx, stderr_rx);
