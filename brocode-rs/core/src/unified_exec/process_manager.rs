    ...
    pub(crate) async fn open_session_with_exec_env(
        ...
        if environment.exec_server_url().is_some() {
            ...
            let started = environment
                .get_exec_backend()
                .start(brocode_exec_server::ExecParams {
        ...
        let spawn_result = if tty {
            brocode_utils_pty::pty::spawn_process_with_inherited_fds(
                program,
                args,
                env.cwd.as_path(),
                &env.env,
            ...
            brocode_utils_pty::pipe::spawn_process_no_stdin_with_inherited_fds(
                program,
                args,
                env.cwd.as_path(),
                &env.env,
