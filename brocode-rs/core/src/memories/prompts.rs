...
use brocode_state::Phase2InputSelection;
use brocode_state::Stage1Output;
use brocode_state::Stage1OutputRef;
...
pub(crate) async fn build_memory_tool_developer_instructions(
    ...
    let base_path = memory_root(brocode_home);
