...
use brocode_api::common::OpenAiVerbosity;
use brocode_api::common::TextControls;
...
fn serializes_text_schema_with_strict_format() {
    ...
    assert_eq!(
        format.get("name"),
        Some(&serde_json::Value::String("brocode_output_schema".into()))
    );
    assert_eq!(
        format.get("type"),
...
fn tool_search_output_namespace_serializes_with_deferred_child_tools() {
    ...
    assert_eq!(
        ...
        serde_json::json!({
            "type": "namespace",
            "name": "mcp__brocode_apps__calendar",
