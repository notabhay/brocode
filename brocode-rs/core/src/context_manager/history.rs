...
use brocode_utils_cache::BlockingLruCache;
use brocode_utils_cache::sha1_digest;
...
use brocode_utils_output_truncation::approx_tokens_from_byte_count_i64;
...
pub(crate) fn is_brocode_generated_item(item: &ResponseItem) -> bool {
    matches!(
        item,
        ResponseItem::FunctionCallOutput { .. }
            | ResponseItem::ToolSearchOutput { .. }
