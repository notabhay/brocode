  ...
  "plugins": [
    ...
    assert_eq!(
        ...
        ResolvedMarketplacePlugin {
            plugin_id: PluginId::new("local-plugin".to_string(), "brocode-curated".to_string())
                .unwrap(),
...
fn resolve_marketplace_plugin_reports_missing_plugin() {
    ...
    fs::write(
        repo_root.join(".agents/plugins/marketplace.json"),
        r#"{"name":"brocode-curated","plugins":[]}"#,
    )
    .unwrap();
    ...
    assert_eq!(
        err.to_string(),
        "plugin `missing` was not found in marketplace `brocode-curated`"
    );
}
...
fn list_marketplaces_returns_home_and_repo_marketplaces() {
  ...
  "plugins": [
    ...
    assert_eq!(
        ...
        vec![
            Marketplace {
                name: "brocode-curated".to_string(),
                path:
...
fn list_marketplaces_resolves_plugin_interface_paths_to_absolute() {
  ...
  "plugins": [
    {
      ...
      "policy": {
        ...
        "products": ["BROCODE", "CHATGPT", "ATLAS"]
      },
      "category": "Design"
    }
  ]
  ...
  "interface": {
    ...
    assert_eq!(
        ...
        Some(vec![Product::Brocode, Product::Chatgpt, Product::Atlas])
    );
    assert_eq!(
...
fn resolve_marketplace_plugin_rejects_disallowed_product() {
  ...
  "plugins": [
    ...
    assert_eq!(
        err.to_string(),
        "plugin `chatgpt-plugin` is not available for install in marketplace `brocode-curated`"
    );
}
...
fn resolve_marketplace_plugin_allows_missing_products_field() {
  ...
  "plugins": [
    ...
    assert_eq!(
        ...
        "default-plugin@brocode-curated"
    );
}
...
fn resolve_marketplace_plugin_rejects_explicit_empty_products() {
  ...
  "plugins": [
    ...
    assert_eq!(
        err.to_string(),
        "plugin `disabled-plugin` is not available for install in marketplace `brocode-curated`"
    );
}
