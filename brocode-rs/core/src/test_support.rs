...
pub fn auth_manager_from_auth(auth: BrocodeAuth) -> Arc<AuthManager> {
...
pub fn auth_manager_from_auth_with_home(
    ...
    AuthManager::from_auth_for_testing_with_home(auth, brocode_home)
}
...
pub fn models_manager_with_provider(
    ...
    ModelsManager::with_provider_for_tests(brocode_home, auth_manager, provider)
}
