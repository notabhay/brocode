...
use brocode_protocol::models::is_image_close_tag_text;
use brocode_protocol::models::is_image_open_tag_text;
use brocode_protocol::models::is_local_image_close_tag_text;
use brocode_protocol::models::is_local_image_open_tag_text;
use brocode_protocol::protocol::COLLABORATION_MODE_OPEN_TAG;
use brocode_protocol::protocol::REALTIME_CONVERSATION_OPEN_TAG;
...
pub fn parse_turn_item(item: &ResponseItem) -> Option<TurnItem> {
    match item {
        ...
        ResponseItem::ImageGenerationCall {
            ...
            brocode_protocol::items::ImageGenerationItem {
                id: id.clone(),
                status: status.clone(),
