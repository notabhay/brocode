...
impl CodeModeExecuteHandler {
    async fn execute(
        &self,
        session: std::sync::Arc<crate::brocode::Session>,
        turn: std::sync::Arc<crate::brocode::TurnContext>,
        call_id: String,
        code: String,
    ) -> Result<FunctionToolOutput, FunctionCallError> {
        let args = brocode_code_mode::parse_exec_source(&code)
        ...
        let response = exec
            ...
            .services
            .code_mode_service
            .execute(brocode_code_mode::ExecuteRequest {
