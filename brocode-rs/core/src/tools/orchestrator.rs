...
use brocode_otel::ToolDecisionSource;
...
impl ToolOrchestrator {
    ...
    pub async fn run<Rq, Out, T>(
        ...
        req: &Rq,
        tool_ctx: &ToolCtx,
        turn_ctx: &crate::brocode::TurnContext,
        ...
        T: ToolRuntime<Rq, Out>,
    {
        ...
        let initial_attempt = SandboxAttempt {
            ...
            brocode_linux_sandbox_exe: turn_ctx.brocode_linux_sandbox_exe.as_ref(),
            use_legacy_landlock,
        ...
        match first_result {
            ...
            Err(ToolError::Brocode(BrocodeErr::Sandbox(SandboxErr::Denied {
                output,
