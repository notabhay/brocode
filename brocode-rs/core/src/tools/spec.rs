...
fn create_wait_tool() -> ToolSpec {
    ...
    ToolSpec::Function(ResponsesApiTool {
        ...
        description: format!(
            ...
            brocode_code_mode::build_wait_tool_description().trim()
        ),
        strict: false,
        parameters: JsonSchema::Object {
            properties,
...
fn create_test_sync_tool() -> ToolSpec {
    ...
    ToolSpec::Function(ResponsesApiTool {
        ...
        description: "Internal synchronization helper used by Brocode integration tests."
            .to_string(),
        strict: false,
        defer_loading: None,
        parameters: JsonSchema::Object {
...
"#;
    ...
    ToolSpec::Freeform(FreeformTool {
        ...
        description: "Runs JavaScript in a persistent Node kernel with top-level await. This is a freeform tool: send raw JavaScript source text, optionally with a first-line pragma like `// brocode-js-repl: timeout_ms=15000`; do not send JSON/quotes/markdown fences."
            .to_string(),
...
"#;
    ...
    ToolSpec::Freeform(FreeformTool {
        ...
        description: brocode_code_mode::build_exec_tool_description(
            enabled_tools,
    ...
    if config.code_mode_enabled {
        ...
        let mut enabled_tools = nested_specs
            ...
            .filter_map(|spec| {
                ...
                brocode_code_mode::is_code_mode_nested_tool(&name).then_some((name, description))
            })
            .collect::<Vec<_>>();
