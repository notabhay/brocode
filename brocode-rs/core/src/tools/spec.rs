...
use brocode_protocol::openai_models::ApplyPatchToolType;
use brocode_protocol::openai_models::ConfigShellToolType;
...
use brocode_protocol::openai_models::WebSearchToolType;
...
use brocode_tools::DiscoverableToolType;
use brocode_tools::ShellToolOptions;
use brocode_tools::SpawnAgentToolOptions;
use brocode_tools::ToolSearchAppInfo;
use brocode_tools::ToolSuggestEntry;
use brocode_tools::ViewImageToolOptions;
use brocode_tools::WaitAgentTimeoutOptions;
use brocode_tools::augment_tool_spec_for_code_mode;
use brocode_tools::create_assign_task_tool;
use brocode_tools::create_close_agent_tool_v1;
use brocode_tools::create_close_agent_tool_v2;
use brocode_tools::create_code_mode_tool;
use brocode_tools::create_exec_command_tool;
use brocode_tools::create_js_repl_reset_tool;
use brocode_tools::create_js_repl_tool;
use brocode_tools::create_list_agents_tool;
use brocode_tools::create_list_dir_tool;
use brocode_tools::create_list_mcp_resource_templates_tool;
use brocode_tools::create_list_mcp_resources_tool;
use brocode_tools::create_read_mcp_resource_tool;
use brocode_tools::create_report_agent_job_result_tool;
...
use brocode_tools::create_shell_command_tool;
use brocode_tools::create_shell_tool;
use brocode_tools::create_spawn_agent_tool_v1;
use brocode_tools::create_spawn_agent_tool_v2;
use brocode_tools::create_spawn_agents_on_csv_tool;
use brocode_tools::create_test_sync_tool;
use brocode_tools::create_tool_search_tool;
use brocode_tools::create_tool_suggest_tool;
...
use brocode_tools::create_wait_tool;
use brocode_tools::create_write_stdin_tool;
use brocode_tools::dynamic_tool_to_responses_api_tool;
use brocode_tools::mcp_tool_to_responses_api_tool;
...
pub type JsonSchema = brocode_tools::JsonSchema;

#[cfg(test)]
pub(crate) use brocode_tools::mcp_call_tool_result_output_schema;
...
impl ToolsConfig {
    pub fn new(params: &ToolsConfigParams) -> Self {
        ...
        let shell_type = if !features.enabled(Feature::ShellTool) {
            ...
            if brocode_utils_pty::conpty_supported() {
...
fn tool_search_app_infos(app_tools: &HashMap<String, ToolInfo>) -> Vec<ToolSearchAppInfo> {
    app_tools
        .values()
        .filter(|tool| tool.server_name == BROCODE_APPS_MCP_SERVER_NAME)
        .filter_map(|tool| {
            let name = tool
                .connector_name
                .as_deref()
