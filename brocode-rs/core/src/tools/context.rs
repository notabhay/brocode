...
use brocode_protocol::models::SearchToolCallParams;
use brocode_protocol::models::ShellToolCallParams;
...
use brocode_utils_output_truncation::formatted_truncate_text;
use brocode_utils_string::take_bytes_at_char_boundary;
use serde::Serialize;
    ...
    match response {
        ResponseInputItem::Message { content, .. } => content_items_to_code_mode_result(
            &content
                .into_iter()
                .map(|item| match item {
                    brocode_protocol::models::ContentItem::InputText { text }
                    | brocode_protocol::models::ContentItem::OutputText { text } => {
                        FunctionCallOutputContentItem::InputText { text }
                    }
                    brocode_protocol::models::ContentItem::InputImage { image_url } => {
