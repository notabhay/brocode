...
use brocode_protocol::approvals::NetworkApprovalContext;
...
pub(crate) enum ExecApprovalRequirement {
    ...
    Skip {
        ...
        /// Only applies if the command fails to run in sandbox and brocode prompts the user to run outside the sandbox.
...
pub(crate) struct SandboxAttempt<'a> {
    ...
    pub brocode_linux_sandbox_exe: Option<&'a std::path::PathBuf>,
    ...
    pub fn env_for(
        ...
        self.manager
            .transform(SandboxTransformRequest {
                ...
                brocode_linux_sandbox_exe: self.brocode_linux_sandbox_exe,
