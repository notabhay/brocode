...
fn serialize_tool_search_output_tools_groups_results_by_namespace() {
    let entries = [
        ...
        (
            "mcp__brocode_apps__gmail_read_email".to_string(),
            ToolInfo {
                server_name: BROCODE_APPS_MCP_SERVER_NAME.to_string(),
    ...
    assert_eq!(
        ...
        vec![
            ToolSearchOutputTool::Namespace(ResponsesApiNamespace {
                name: "mcp__brocode_apps__calendar".to_string(),
            ...
            ToolSearchOutputTool::Namespace(ResponsesApiNamespace {
                name: "mcp__brocode_apps__gmail".to_string(),
...
fn serialize_tool_search_output_tools_falls_back_to_connector_name_description() {
    let entries = [(
        "mcp__brocode_apps__gmail_batch_read_email".to_string(),
        ToolInfo {
            server_name: BROCODE_APPS_MCP_SERVER_NAME.to_string(),
