...
use crate::brocode::build_prompt;
use crate::brocode::built_tools;
use crate::client::ModelClientSession;
use crate::error::Result as BrocodeResult;
use brocode_otel::SessionTelemetry;
use brocode_otel::metrics::names::STARTUP_PREWARM_AGE_AT_FIRST_TURN_METRIC;
use brocode_otel::metrics::names::STARTUP_PREWARM_DURATION_METRIC;
use brocode_protocol::models::BaseInstructions;

pub(crate) struct SessionStartupPrewarmHandle {
    task: JoinHandle<BrocodeResult<ModelClientSession>>,
    started_at: Instant,
    timeout: Duration,
}
...
impl SessionStartupPrewarmHandle {
    ...
    fn resolution_from_join_result(
        result: std::result::Result<BrocodeResult<ModelClientSession>, tokio::task::JoinError>,
        started_at: Instant,
    ) -> SessionStartupPrewarmResolution {
        match result {
...
) -> BrocodeResult<ModelClientSession> {
