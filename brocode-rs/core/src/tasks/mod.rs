...
use brocode_otel::metrics::names::TURN_E2E_DURATION_METRIC;
use brocode_otel::metrics::names::TURN_NETWORK_PROXY_METRIC;
use brocode_otel::metrics::names::TURN_TOKEN_USAGE_METRIC;
use brocode_otel::metrics::names::TURN_TOOL_CALL_METRIC;
...
///
/// Implementations encapsulate a specific Brocode workflow (regular chat,
