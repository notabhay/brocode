use brocode_instructions::AGENTS_MD_FRAGMENT;
use brocode_instructions::ContextualUserFragmentDefinition;
use brocode_instructions::SKILL_FRAGMENT;
use brocode_protocol::items::HookPromptItem;
use brocode_protocol::items::parse_hook_prompt_fragment;
use brocode_protocol::models::ContentItem;
use brocode_protocol::protocol::ENVIRONMENT_CONTEXT_CLOSE_TAG;
