...
use brocode_protocol::protocol::HookExecutionMode;
use brocode_protocol::protocol::HookHandlerType;
use brocode_protocol::protocol::HookRunStatus;
use brocode_protocol::protocol::HookRunSummary;
use brocode_protocol::protocol::HookScope;
...
pub(crate) fn completed_summary(
    ...
    entries: Vec<brocode_protocol::protocol::HookOutputEntry>,
) -> HookRunSummary {
    HookRunSummary {
        id: handler.run_id(),
        event_name: handler.event_name,
