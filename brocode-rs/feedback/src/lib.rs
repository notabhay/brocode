...
#[derive(Clone)]
pub struct BrocodeFeedback {
    inner: Arc<FeedbackInner>,
}

impl Default for BrocodeFeedback {
    fn default() -> Self {
        Self::new()
    }
}

impl BrocodeFeedback {
    pub fn new() -> Self {
...
impl FeedbackSnapshot {
    ...
    pub fn save_to_temp_file(&self) -> io::Result<PathBuf> {
        ...
        let filename = format!("brocode-feedback-{}.log", self.thread_id);
    ...
    fn feedback_attachments(
        ...
        if include_logs {
            attachments.push(Attachment {
                ...
                filename: String::from("brocode-logs.log"),
...
mod tests {
    ...
    fn ring_buffer_drops_front_when_full() {
        let fb = BrocodeFeedback::with_capacity(/*max_bytes*/ 8);
        {
    ...
    fn feedback_attachments_gate_connectivity_diagnostics() {
        ...
        let attachments_without_diagnostics = BrocodeFeedback::new()
            .snapshot(/*session_id*/ None)
