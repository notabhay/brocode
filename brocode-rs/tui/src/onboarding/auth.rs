...
use brocode_core::auth::read_openai_api_key_from_env;
use brocode_login::DeviceCode;
...
fn onboarding_request_id() -> brocode_app_server_protocol::RequestId {
    brocode_app_server_protocol::RequestId::String(Uuid::new_v4().to_string())
}
...
impl AuthModeWidget {
            ...
            SignInState::ChatGptContinueInBrowser(state) => {
                ...
                tokio::spawn(async move {
                    let _ = request_handle
                        .request_typed::<brocode_app_server_protocol::CancelLoginAccountResponse>(
    ...
    fn render_pick_mode(&self, area: Rect, buf: &mut Buffer) {
        let mut lines: Vec<Line> = vec![
            Line::from(vec![
                "  ".into(),
                "Sign in with ChatGPT to use Brocode as part of your paid plan".into(),
            ]),
            Line::from(vec![
                "  ".into(),
    ...
    fn render_chatgpt_success_message(&self, area: Rect, buf: &mut Buffer) {
        let lines = vec![
            ...
            "".into(),
            "  Decide how much autonomy you want to grant Brocode".into(),
            Line::from(vec![
                "  For more details see the ".into(),
                "\u{1b}]8;;https://developers.openai.com/brocode/security\u{7}Brocode docs\u{1b}]8;;\u{7}".underlined(),
            ])
            .dim(),
            "".into(),
            "  Brocode can make mistakes".into(),
    ...
    fn render_api_key_configured(&self, area: Rect, buf: &mut Buffer) {
        let lines = vec![
            ...
            "".into(),
            "  Brocode will use usage-based billing with your API key.".into(),
        ];
...
mod tests {
    ...
    async fn widget_forced_chatgpt() -> (AuthModeWidget, TempDir) {
        ...
        let config = ConfigBuilder::default()
            .brocode_home(brocode_home_path.clone())
            .build()
            .await
            .unwrap();
