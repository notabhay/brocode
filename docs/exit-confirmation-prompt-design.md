...
This document describes how exit, shutdown, and interruption work in the Rust TUI (`brocode-rs/tui`).
It is intended for Brocode developers and Brocode itself when reasoning about future exit/shutdown
changes.
...
Brocode has historically mixed "exit immediately" and "shutdown-first" across quit gestures, largely
