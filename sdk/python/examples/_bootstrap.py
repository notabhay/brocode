...
def ensure_local_sdk_src() -> Path:
    ...
    package_dir = src_dir / "brocode_app_server"
...
def runtime_config():
    ...
    from brocode_app_server import AppServerConfig
...
def temporary_sample_image_path() -> Iterator[Path]:
    with tempfile.TemporaryDirectory(prefix="brocode-python-example-image-") as temp_root:
