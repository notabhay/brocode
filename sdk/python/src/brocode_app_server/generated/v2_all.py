...
#   filename:  brocode_app_server_protocol.v2.schemas.json
...
class BrocodeAppServerProtocolV2(BaseModel):
    pass
...
class BrocodeErrorInfoValue(Enum):
...
class HttpConnectionFailedBrocodeErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseStreamConnectionFailedBrocodeErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseStreamDisconnectedBrocodeErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseTooManyFailedAttemptsBrocodeErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ProjectConfigLayerSource(BaseModel):
    ...
    dot_brocode_folder: Annotated[AbsolutePathBuf, Field(alias="dotBrocodeFolder")]
...
class ExternalAgentConfigDetectParams(BaseModel):
    ...
    include_home: Annotated[
        ...
        Field(
            alias="includeHome",
            description="If true, include detection under the user's home (~/.claude, ~/.brocode, etc.).",
        ),
    ] = None
...
class ChatgptAuthTokensLoginAccountParams(BaseModel):
    ...
    chatgpt_plan_type: Annotated[
        ...
        Field(
            ...
            description="Optional plan type supplied by the client.\n\nWhen `null`, Brocode attempts to derive the plan type from access-token claims. If unavailable, the plan defaults to `unknown`.",
        ),
    ] = None
    type: Annotated[
...
class ActiveTurnNotSteerableBrocodeErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class BrocodeErrorInfo(
    RootModel[
        BrocodeErrorInfoValue
        | HttpConnectionFailedBrocodeErrorInfo
        | ResponseStreamConnectionFailedBrocodeErrorInfo
        | ResponseStreamDisconnectedBrocodeErrorInfo
        | ResponseTooManyFailedAttemptsBrocodeErrorInfo
        | ActiveTurnNotSteerableBrocodeErrorInfo
    ]
):
    model_config = ConfigDict(
        populate_by_name=True,
...
class TurnError(BaseModel):
    ...
    brocode_error_info: Annotated[
        BrocodeErrorInfo | None, Field(alias="brocodeErrorInfo")
    ] = None
    message: str
...
class GetAccountRateLimitsResponse(BaseModel):
    ...
    rate_limits_by_limit_id: Annotated[
        ...
        Field(
            ...
            description="Multi-bucket view keyed by metered `limit_id` (for example, `brocode`).",
        ),
    ] = None
...
class Thread(BaseModel):
    ...
    source: Annotated[
        SessionSource,
        Field(
            description="Origin of the thread (CLI, VSCode, brocode exec, brocode app-server, etc.)."
        ),
    ]
    status: Annotated[
