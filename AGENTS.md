...
- For MCP tool-call interception work, prefer capability-driven custom MCP requests over broad generic call-path rewrites when the server can own the transformation logic.
