{
  description = "Development Nix flake for OpenAI Brocode CLI";
  ...
  outputs = { self, nixpkgs, rust-overlay, ... }:
    let
      ...
      cargoToml = builtins.fromTOML (builtins.readFile ./brocode-rs/Cargo.toml);
    ...
    in
    {
      packages = forAllSystems (system:
        let
          ...
          brocode-rs = pkgs.callPackage ./brocode-rs {
            inherit version;
